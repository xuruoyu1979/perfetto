...
<EventDictionary>
    <EventClass key="apex" displayName="Apex Events" helpTopicId="VXWORKSAE653_apex_CLASS_HELP">
        <EventDescription id="10500" name="EVENT_APEX_CREATESEMA" trigger="false" displayName="apexSemCreate" icon="images/apexSemCreate.gif" helpTopicId="VXWORKSAE653_EVENT_APEX_CREATESEMA_EVENT_HELP">
            <EventParam type="UINT64" name="maxValue"/>
            <EventParam type="UINT64" name="currentValue"/>
            <EventParam type="UINT64" name="discipline"/>
            <EventParam type="UINT64" name="semId" formatStr="0x%016llx"/>
        </EventDescription>
        <EventDescription id="10501" name="EVENT_APEX_WAITSEMA" trigger="false" displayName="apexSemWait" icon="images/apexSemWait.gif" helpTopicId="VXWORKSAE653_EVENT_APEX_WAITSEMA_EVENT_HELP">
            <EventParam type="UINT64" name="timeout"/>
            <EventParam type="UINT64" name="count"/>
            <EventParam type="UINT64" name="semId" formatStr="0x%016llx"/>
        </EventDescription>
        <EventDescription id="10502" name="EVENT_APEX_SIGNALSEMA" trigger="false" displayName="apexSemSignal" icon="images/apexSemSignal.gif" helpTopicId="VXWORKSAE653_EVENT_APEX_SIGNALSEMA_EVENT_HELP">
            <EventParam type="UINT64" name="count"/>
            <EventParam type="UINT64" name="maxCount"/>
            <EventParam type="UINT64" name="semId" formatStr="0x%016llx"/>
        </EventDescription>
        <EventDescription id="10503" name="EVENT_APEX_CREATEBUFFER" trigger="false" displayName="apexBufferCreate" icon="images/apexBuffCreate.gif" helpTopicId="VXWORKSAE653_EVENT_APEX_CREATEBUFFER_EVENT_HELP">
            <EventParam type="UINT64" name="discipline"/>
            <EventParam type="UINT64" name="messageSize"/>
            <EventParam type="UINT64" name="bufferSize"/>
            <EventParam type="UINT64" name="bufferId" formatStr="0x%016llx"/>
        </EventDescription>
        <EventDescription id="10504" name="EVENT_APEX_SENDBUFFER" trigger="false" displayName="apexBufferSend" icon="images/apexBuffSend.gif" helpTopicId="VXWORKSAE653_EVENT_APEX_SENDBUFFER_EVENT_HELP">
            <EventParam type="UINT64" name="timeout"/>
            <EventParam type="UINT64" name="length"/>
            <EventParam type="UINT64" name="bufferId" formatStr="0x%016llx"/>
        </EventDescription>
        ...
        <EventDescription id="10506" name="EVENT_APEX_CREATEEVENT" trigger="false" displayName="apexEventCreate" icon="images/apexEventCreate.gif" helpTopicId="VXWORKSAE653_EVENT_APEX_CREATEEVENT_EVENT_HELP">
            <EventParam type="UINT64" name="state"/>
            <EventParam type="UINT64" name="eventId" formatStr="0x%016llx"/>
        </EventDescription>
        ...
        <EventDescription id="10510" name="EVENT_APEX_CREATEBLACKB" trigger="false" displayName="apexBlackboardCreate" icon="images/apexBlackboardCreate.gif" helpTopicId="VXWORKSAE653_EVENT_APEX_CREATEBLACKB_EVENT_HELP">
            <EventParam type="UINT64" name="msgSize"/>
            <EventParam type="UINT64" name="blackboardId" formatStr="0x%016llx"/>
        </EventDescription>
        ...
        <EventDescription id="10514" name="EVENT_APEX_TIMEDWAIT" trigger="false" displayName="apexTimedWait" icon="images/apexTimedWait.gif" helpTopicId="VXWORKSAE653_EVENT_APEX_TIMEDWAIT_EVENT_HELP">
            <EventParam type="UINT64" name="ticks"/>
            <EventParam type="UINT64" name="procId" formatStr="0x%016llx"/>
        </EventDescription>
        ...
        <EventDescription id="10517" name="EVENT_APEX_CREATEPROC" trigger="false" displayName="apexProcessCreate" icon="images/apexProcessCreate.gif" helpTopicId="VXWORKSAE653_EVENT_APEX_CREATEPROC_EVENT_HELP">
            <EventParam type="UINT64" name="deadline" formatStr="%d"/>
            <EventParam type="UINT64" name="period" formatStr="%d"/>
            <EventParam type="UINT64" name="stack" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="priority" formatStr="%d"/>
            <EventParam type="UINT64" name="procId" formatStr="0x%016llx"/>
        </EventDescription>
        ...
        <EventDescription id="10519" name="EVENT_APEX_SUSPENDSELF" trigger="false" displayName="apexSuspendSelf" icon="images/apexSuspendSelf.gif" helpTopicId="VXWORKSAE653_EVENT_APEX_SUSPENDSELF_EVENT_HELP">
            <EventParam type="UINT64" name="ticks" formatStr="%d"/>
            <EventParam type="UINT64" name="procId" formatStr="0x%016llx"/>
        </EventDescription>
        ...
        <EventDescription id="10525" name="EVENT_APEX_LOCK" trigger="false" displayName="apexLockPreemption" icon="images/apexLock.gif" helpTopicId="VXWORKSAE653_EVENT_APEX_LOCK_EVENT_HELP"> 
            <EventParam type="UINT64" name="newLockLevel"/>
        </EventDescription>
        ...
        <EventDescription id="10527" name="EVENT_APEX_CREATSPORT"
            ...
            <EventParam type="UINT64" name="size" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="period"/>
            <EventParam type="UINT64" name="direction" />
            <EventParam type="UINT64" name="portId" formatStr="0x%016llx"/>
        </EventDescription>
        ...
        <EventDescription id="10528" name="EVENT_APEX_WRITESPORT"
            ...
            <EventParam type="UINT64" name="length" />
            <EventParam type="UINT64" name="message" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="portId" formatStr="0x%016llx"/>
        </EventDescription>
        ...
        <EventDescription id="10530" name="EVENT_APEX_CREATQPORT"
            ...
            <EventParam type="UINT64" name="maxMsgSize" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="maxMsg" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="discipline" />
            <EventParam type="UINT64" name="direction" />
            <EventParam type="UINT64" name="portId" formatStr="0x%016llx"/>
        </EventDescription>
        ...
        <EventDescription id="10532" name="EVENT_APEX_RECEIVEQPORT"
            ...
            <EventParam type="UINT64" name="timeout" />
            <EventParam type="UINT64" name="maxLength" />
            <EventParam type="UINT64" name="message" formatStr="0x%016llx" />
            <EventParam type="UINT64" name="portId" formatStr="0x%016llx"/>
        </EventDescription>
        ...
        <EventDescription id="10533" name="EVENT_APEX_CREATEMUTEX"
            ...
            <EventParam type="UINT64" name="priority" />
            <EventParam type="UINT64" name="discipline" />
            <EventParam type="UINT64" name="mutexId" formatStr="0x%016llx"/>
        </EventDescription>
        ...
        <EventDescription id="10600" name="EVENT_SCHED_MAJORFRAME" trigger="true" displayName="schedulerMajorFrame" icon="images/schedMajorFrame.gif" helpTopicId="EVENT_SCHED_MAJORFRAME_HELP">
            <EventParam type="UINT64" name="schedule" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="newPartition" formatStr="0x%016llx"/>
        </EventDescription>
...
/*
modification history
01e,20dec10,tcr  Fix errors in xml for 64bit logs
...
<EventDictionary>
  ...
  helpTopicId="VXWORKS6_edr_CLASS_HELP">
    ...
    helpTopicId="VXWORKS6_EDR_ERROR_INJECT_EVENT_HELP">
      ...
      <EventParam type="UINT64" name="address" formatStr="0x%016llx" />
...
/*
modification history
01c,01feb10,tcr  update for 64bit
    ...
    <EventClass key="io" displayName="I/O Events" helpTopicId="VXWORKS6_IOLIB_CLASS_HELP">
        <EventDescription id="10048" name="EVENT_IOOPEN" trigger="true"
         displayName="open" icon="images/open.gif" helpTopicId="VXWORKS6_EVENT_IOOPEN_EVENT_HELP">
            <EventParam type="UINT64" name="fd" isSearchKey="true"/>
            <EventParam type="UINT64" name="flags" formatStr="0x%llx"/>
        ...
        <EventDescription id="10049" name="EVENT_IOREAD" trigger="true"
         displayName="read" icon="images/read.gif" helpTopicId="VXWORKS6_EVENT_IOREAD_EVENT_HELP">
            <EventParam type="UINT64" name="fd" isSearchKey="true"/>
            <EventParam type="UINT64" name="bytesRead"/>
            <EventParam type="UINT64" name="buffer" formatStr="0x%016llx"/>
        ...
        <EventDescription id="10050" name="EVENT_IOWRITE" trigger="true"
         displayName="write" icon="images/write.gif" helpTopicId="VXWORKS6_EVENT_IOWRITE_EVENT_HELP">
            <EventParam type="UINT64" name="fd" isSearchKey="true"/>
            <EventParam type="UINT64" name="bytesWritten"/>
            <EventParam type="UINT64" name="buffer" formatStr="0x%016llx"/>
            <EventParam type="BLOB" name="data" formatter="com.windriver.windview.agnostic.wv.SmartHexAsciiFormatter"/>
        </EventDescription>
        ...
        <EventDescription id="10051" name="EVENT_IOIOCTL" trigger="true"
         displayName="ioctl" icon="images/ioctl.gif" helpTopicId="VXWORKS6_EVENT_IOIOCTL_EVENT_HELP">
            <EventParam type="UINT64" name="arg" />
            <EventParam type="UINT64" name="cmd" />
            <EventParam type="UINT64" name="fd" isSearchKey="true"/>
        </EventDescription>
        ...
        <EventDescription id="10053" name="EVENT_IOCREAT" trigger="true"
         displayName="creat" icon="images/creat.gif" helpTopicId="VXWORKS6_EVENT_IOCREAT_EVENT_HELP">
            <EventParam type="UINT64" name="fd"/>
            <EventParam type="UINT64" name="mode" formatStr="%o"/>
            <EventParam type="BLOB" name="name" formatter="com.windriver.windview.agnostic.wv.SmartHexAsciiFormatter"/>
        </EventDescription>
...
/*
modification history
01c,01feb10,tcr  update for 64bit parameters
...
<EventDictionary>
    <EventClass key="isr" displayName="ISR Events" helpTopicId="VXWORKS6_isr_CLASS_HELP">
        ...
        <EventDescription id="9" name="EVENT_ISR_INFO" trigger="false" hasTimeStamp="false" displayName="isrInfo" helpTopicId="VXWORKS6_EVENT_ISR_INFO_EVENT_HELP">
            <EventParam type="UINT64" name="isrId" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="isrHandler" formatStr="0x%016llx"/>
        ...
        <EventDescription id="10060" name="EVENT_ISR_DISPATCHER_INVOKE" trigger="true" displayName="isrDispatch" icon="images/isrDispatcherInvoke.gif" helpTopicId="VXWORKS6_EVENT_ISR_DISPATCH_EVENT_HELP">
            <EventParam isSearchKey="true" type="UINT64" name="isrId" formatStr="0x%016llx"/>
        </EventDescription>
        ...
        <EventDescription id="10062" name="EVENT_ISR_CREATE" trigger="true" displayName="isrCreate" icon="images/isrCreate.gif" helpTopicId="VXWORKS6_EVENT_ISR_CREATE_EVENT_HELP">
            <EventParam type="UINT64" name="options" formatStr="%d"/>
            <EventParam type="UINT64" name="param" formatStr="%lld"/>
            <EventParam type="UINT64" name="rtn" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="tag" formatStr="%lld"/>
            <EventParam isSearchKey="true" type="UINT64" name="isrId"
            formatStr="0x%016llx"/>
        </EventDescription>
...
/* Copyright 2008,2010, 2016 Wind River Systems, Inc. */

/*
modification history
01d,28jan16,saj  WB4-6504: a mistake, UINT32 -> UINT64.
01c,25jan16,saj  WB4-6490: miss some events.
01b,01feb10,tcr  update for 64bit parameters
...
<EventDictionary>
    <EventClass key="mem" displayName="Memory Events" helpTopicId="VXWORKS6_mem_CLASS_HELP">
        <EventDescription id="10030" name="EVENT_MEMALLOC" trigger="true" displayName="memPartAlignedAlloc" icon="images/memPartAlignedAlloc.gif" helpTopicId="VXWORKS6_EVENT_MEMALLOC_EVENT_HELP">
            <EventParam isSearchKey="true" type="UINT64" name="partId" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="pBlock" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="nBytesPlusHeaderAlign"/>
            <EventParam type="UINT64" name="nBytes"/>
        </EventDescription>
        ...
        <EventDescription id="10032" name="EVENT_MEMPARTCREATE" trigger="true" displayName="memPartCreate" icon="images/memPartCreate.gif" helpTopicId="VXWORKS6_EVENT_MEMPARTCREATE_EVENT_HELP">
            <EventParam isSearchKey="true" type="UINT64" name="partId" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="poolSize"/>
        </EventDescription>
        <EventDescription id="10033" name="EVENT_MEMREALLOC" trigger="true" displayName="memPartRealloc" icon="images/memPartRealloc.gif" helpTopicId="VXWORKS6_EVENT_MEMREALLOC_EVENT_HELP">
            <EventParam isSearchKey="true" type="UINT64" name="partId" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="pNewBlock" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="nBytesPlusHeaderAlign"/>
            <EventParam type="UINT64" name="pBlock" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="nBytes"/>
        </EventDescription>
        ...
        <EventDescription id="15000" name="EVENT_RTP_MEMALLOC" trigger="true" displayName="memPartBlkAlignedAlloc-rtp" icon="images/memPartAlignedAlloc.gif" helpTopicId="VXWORKS6_EVENT_MEMALLOC_EVENT_HELP">
            <EventParam isSearchKey="true" type="UINT64" name="pPartition" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="addr" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="bytesReq"/>
            <EventParam type="UINT64" name="bytesAlloc"/>
        </EventDescription>
        <EventDescription id="15001" name="EVENT_RTP_MEMFREE" trigger="true" displayName="memPartFreeInternal-rtp" icon="images/memPartFree.gif" helpTopicId="VXWORKS6_EVENT_MEMFREE_EVENT_HELP">
            <EventParam isSearchKey="true" type="UINT64" name="pPartition" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="addr" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="bytesFree"/>
        </EventDescription>
        <EventDescription id="15002" name="EVENT_RTP_MEMPARTCREATE" trigger="true" displayName="memPartCreate-rtp" icon="images/memPartCreate.gif" helpTopicId="VXWORKS6_EVENT_MEMPARTCREATE_EVENT_HELP">
            <EventParam isSearchKey="true" type="UINT64" name="pPartition" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="pPool" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="poolSize"/>
        </EventDescription>
...
<EventDictionary>
    <EventClass key="windnet_dual_stack" displayName="WindNet IPv6/IPv4 Network events" helpTopicId="VXWORKS6_windnet_dual_stack_CLASS_HELP">
	    ...
	    <EventParam type="UINT64" name="wvEvtInfo" formatter="com.windriver.windview.plugins.wv.windnet.formatters.wvNetDInfoDecoder"/>
	    <EventParam type="UINT64" name="Func" formatStr="0x%016llx"/>
	    <EventParam type="UINT64" name="Qualifier" formatter="com.windriver.windview.plugins.wv.windnet.formatters.QualifierDecoder"/>
	    ...
	    <EventParam type="UINT64" name="wvEvtInfo" formatter="com.windriver.windview.plugins.wv.windnet.formatters.wvNetDInfoDecoder"/>
	    <EventParam type="UINT64" name="Func" formatStr="0x%016llx"/>
	    <EventParam type="UINT64" name="SubType" formatter="com.windriver.windview.plugins.wv.windnet.formatters.InfoSubTypeDecoder"/>
            <EventParam type="BLOB" name="P1-2" formatter="com.windriver.windview.plugins.wv.windnet.formatters.NetBlobDecoder"/>
        </EventDescription>
	    ...
	    <EventParam type="UINT64" name="wvEvtInfo" formatter="com.windriver.windview.plugins.wv.windnet.formatters.wvNetDInfoDecoder"/>
	    <EventParam type="UINT64" name="Func" formatStr="0x%016llx"/>
	    <EventParam type="UINT64" name="P0" formatStr="0x%016llx"/>
            <EventParam type="BLOB" name="P1-2" formatter="com.windriver.windview.plugins.wv.windnet.formatters.NetBlobDecoder"/>
        </EventDescription>
...
/*
modification history
01b,01feb10,tcr  changes for 64bit params
...
<EventDictionary>
    <EventClass key="obj" displayName="OBJ Events" helpTopicId="VXWORKS6_obj_CLASS_HELP">
        <EventDescription id="10059" name="EVENT_OBJ_OWNERSET" trigger="true" displayName="objOwnerSet" icon="images/objOwnerSet.gif" helpTopicId="VXWORKS6_EVENT_OBJ_OWNERSET_EVENT_HELP">
            <EventParam isSearchKey="true" type="UINT64" name="objId" formatStr="0x%016llx"/>
            <EventParam  type="UINT64" name="ownerId" formatStr="0x%016llx"/>
        </EventDescription>
...
<EventDictionary>
  <EventClass key="deviceNet" displayName="WIND NET DeviceNet Events" helpTopicId="VXWORKS6_deviceNet_CLASS_HELP">
    <EventDescription id="26001" name="EVENT_DNET_MSG_PROCESS" displayName="dnetMsgProcess" icon="images/dnetMsgProcess.gif" helpTopicId="VXWORKS6_EVENT_DNET_MSG_PROCESS_HELP">
      <EventParam type="UINT64" name="cnxnId" formatStr="0x%016llx"/>
    ...
    <EventDescription id="26002" name="EVENT_DNET_CNXN_TIMEOUT" displayName="dnetCnxnTimeout" icon="images/dnetCnxnTimeout.gif" helpTopicId="VXWORKS6_EVENT_DNET_CNXN_TIMEOUT_HELP">
      <EventParam type="UINT64" name="instId" formatStr="0x%016llx"/>
      <EventParam type="UINT32" name="descSize" formatStr="%d"/>
      <EventParam type="STRING" name="description" formatStr="%s"/>
    </EventDescription>
  </EventClass>
...
<EventDictionary>
    <EventClass key="powerMng" displayName="Power Management Events" helpTopicId="VXWORKS6_pwm_CLASS_HELP">
        <EventDescription id="10240" name="EVENT_PPM_SYS_POLICY_SET" trigger="true" displayName="pwrPolicyMgrSysSetProcess" icon="images/powe_set.gif" helpTopicId="VXWORKS6_EVENT_PPM_SYS_POLICY_SET_HELP">
            <EventParam type="UINT64" name="sStateCapability" />
        </EventDescription>
	    ...
	    <EventParam type="BLOB" name="data"/>
        </EventDescription>
        <EventDescription id="10242" name="EVENT_PPM_DEV_POLICY_SET" trigger="true" displayName="pwrPolicyMgrDevSetProcess" icon="images/powe_set_d.gif" helpTopicId="VXWORKS6_EVENT_PPM_DEV_POLICY_SET_HELP">
            <EventParam type="UINT64" name="unitNum" />
            <EventParam type="UINT64" name="timeout" />
            <EventParam type="UINT64" name="dStateCapability" />
        ...
        <EventDescription id="10245" name="EVENT_POWER_DOWN" trigger="true" displayName="windPwrDown" icon="images/powe_down.gif" helpTopicId="VXWORKS6_EVENT_POWER_DOWN_HELP">            
            <EventParam type="UINT64" name="powerMode"/>
            <EventParam type="UINT64" name="waitTicks"/>
        </EventDescription>
        ...
        <EventDescription id="10247" name="EVENT_POWER_PSTATE_SET" trigger="true" displayName="pwrCpuPStateSet" icon="images/powe_P.gif" helpTopicId="VXWORKS6_EVENT_POWER_PSTATE_SET_HELP">
            <EventParam type="UINT64" name="cpuId"/>
            <EventParam type="UINT64" name="newPState"/>
            <EventParam type="UINT64" name="oldPState"/>
        </EventDescription>
        <EventDescription id="10248" name="EVENT_POWER_CSTATE_SET" trigger="true" displayName="pwrCpuCStateSet" icon="images/powe_c.gif" helpTopicId="VXWORKS6_EVENT_POWER_CSTATE_SET_HELP">
            <EventParam type="UINT64" name="newCState"/>
        </EventDescription>
        <EventDescription id="10249" name="EVENT_POWER_DSTATE_SET" trigger="true" displayName="pwrDeviceStateSet" icon="images/powe_d.gif" helpTopicId="VXWORKS6_EVENT_POWER_DSTATE_SET_HELP">
            <EventParam type="UINT64" name="pwrDevId" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="newDState"/>
        </EventDescription>
        <EventDescription id="10250" name="EVENT_POWER_DEV_ENABLE_SET" trigger="true" displayName="pwrDeviceEnableSet" icon="images/powe_pev.gif" helpTopicId="VXWORKS6_EVENT_POWER_DEV_ENABLE_SET_HELP">
            <EventParam type="UINT64" name="pwrDevId" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="flag"/>
        </EventDescription>
        ...
        <EventDescription id="10253" name="EVENT_PPM_CPU_LOAD_MON_CONF" trigger="true" displayName="pwrCpuMonConfigure" icon="images/powe_set_m.gif" helpTopicId="VXWORKS6_EVENT_CPU_LOAD_MON_CONF_HELP">
            <EventParam type="UINT64" name="cpuNum" />
	    <EventParam type="BLOB" name="data"/>
        </EventDescription>
    </EventClass>
</EventDictionary>
...
<EventDictionary>
    <EventClass key="rtpLib" displayName="rtpLib Events" helpTopicId="VXWORKS6_RTP_CLASS_HELP">
        ...
        <EventDescription id="16" name="EVENT_RTPNAME" hasTimeStamp="false" isSearchable="false" helpTopicId="VXWORKS6_EVENT_RTPNAME_EVENT_HELP">
            <EventParam type="UINT64" name="options" />
            <EventParam type="UINT64" name="ownerId" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="rtpId" formatStr="0x%016llx"/>
            <EventParam type="BLOB" name="name" formatStr="%s"/>
        </EventDescription>
        ...
        helpTopicId="VXWORKS6_EVENT_RTP_SPAWN_HELP" icon="images/rtpSpawn.gif">
            <EventParam type="UINT64" name="options" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="stackSize" />
            <EventParam type="UINT64" name="priority" />
            <EventParam type="UINT64" isSearchKey="true" name="rtpId" formatStr="0x%016llx"/>
        </EventDescription>
        ...
        helpTopicId="VXWORKS6_EVENT_RTP_INIT_TASK_HELP" icon="images/rtpInitTask.gif">
            <EventParam type="UINT64" name="initialStack" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="pEnv" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="pArgv" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="numArgs" />
            <EventParam type="UINT64" isSearchKey="true" name="rtpId" formatStr="0x%016llx"/>
        </EventDescription>
        ...
        helpTopicId="VXWORKS6_EVENT_RTP_LOAD_HELP" icon="images/rtpLoad.gif">
            <EventParam type="UINT64" name="dataSize" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="dataStart" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="textSize" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="textStart" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="entrAddr" formatStr="0x%016llx"/>
            <EventParam type="UINT64" isSearchKey="true" name="rtpId" formatStr="0x%016llx"/>
        </EventDescription>
...
/*
modification history
01f,01feb10,tcr  update for 64bit parameters
...
<EventDictionary>
    <EventClass key="rtpSig" displayName="RTP Signal Handling" helpTopicId="VXWORKS6_rtpsig_CLASS_HELP">
        <EventDescription id="10083" name="EVENT_RTPKILL" trigger="true" displayName="rtpKill" icon="images/rtpkill.gif" helpTopicId="VXWORKS6_EVENT_RTPKILL_EVENT_HELP">
            <EventParam isSearchKey="true" type="UINT64" name="rtpId" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="signo"/>
        </EventDescription>
        ...
        <EventDescription id="10084" name="EVENT_RTPSIGNAL" trigger="true" displayName="rtpSignal" icon="images/rtpsignal.gif" helpTopicId="VXWORKS6_EVENT_RTPSIGNAL_EVENT_HELP">
            <EventParam isSearchKey="true" type="UINT64" name="rtpId" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="signo"/>
            <EventParam type="UINT64" name="action" formatStr="0x%016llx"/>
        </EventDescription>
        ...
        <EventDescription id="10085" name="EVENT_RTPSUSPEND" trigger="true" displayName="rtpSuspend" icon="images/rtpsigsuspend.gif" helpTopicId="VXWORKS6_EVENT_RTPSUSPEND_EVENT_HELP">
            <EventParam isSearchKey="true" type="UINT64" name="sigset" formatStr="0x%x"/>
        </EventDescription>
        ...
        <EventDescription id="10087" name="EVENT_RTPTASKKILL" trigger="true" displayName="rtpTaskKill" icon="images/rtptaskkill.gif" helpTopicId="VXWORKS6_EVENT_RTPTASKKILL_EVENT_HELP">
            <EventParam isSearchKey="true" type="UINT64" name="tid" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="signal"/>
        </EventDescription>
        ...
        <EventDescription id="10088" name="EVENT_RTPSIGQUEUE" trigger="true" displayName="rtpSigqueue" icon="images/rtpsigqueue.gif" helpTopicId="VXWORKS6_EVENT_RTPSIGQUEUE_EVENT_HELP">
            <EventParam isSearchKey="true" type="UINT64" name="rtpId" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="signal"/>
            <EventParam type="UINT64" name="value" formatStr="0x%016llx"/>
        </EventDescription>
        ...
        <EventDescription id="10089" name="EVENT_RTPTASKSIGQUEUE" trigger="true" displayName="rtpTaskSigqueue" icon="images/rtptasksigqueue.gif" helpTopicId="VXWORKS6_EVENT_RTPTASKSIGQUEUE_EVENT_HELP">
            <EventParam isSearchKey="true" type="UINT64" name="taskId" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="signal"/>
            <EventParam type="UINT64" name="value" formatStr="0x%016llx"/>
        </EventDescription>
        ...
        <EventDescription id="10090" name="EVENT_RTPCHILDWAIT" trigger="true" displayName="rtpChildWait" icon="images/rtpchildwait.gif" helpTopicId="VXWORKS6_EVENT_RTPCHILDWAIT_EVENT_HELP">
            <EventParam isSearchKey="true" type="UINT64" name="childRtpId" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="options" formatStr="0x%x"/>
        </EventDescription>
        ...
        <EventDescription id="10091" name="EVENT_RTPSIGTIMEDWAIT" trigger="true" displayName="rtpSigtimedwait" icon="images/rtpsigtimedwait.gif" helpTopicId="VXWORKS6_EVENT_RTPSIGTIMEDWAIT_EVENT_HELP">
            <EventParam type="UINT64" isSearchKey="true" name="rtpId" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="pSigset" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="pInfo" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="timeout"/>
        </EventDescription>
        ...
        <EventDescription id="10092" name="EVENT_RTPSIGWRAPPER" trigger="true" displayName="rtpSigWrapper" icon="images/rtpsigwrapper.gif" helpTopicId="VXWORKS6_EVENT_RTPSIGWRAPPER_EVENT_HELP">
            <EventParam type="UINT64" isSearchKey="true" name="rtpId" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="type"/>
        ...
        <EventDescription id="10094" name="EVENT_RTPSIGPROCMASK" trigger="true" displayName="rtpSigProcMask" icon="images/rtpsigprocmask.gif" helpTopicId="VXWORKS6_EVENT_RTPSIGPROCMASK_EVENT_HELP">
            <EventParam type="UINT64" isSearchKey="true" name="rtpId" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="how"/>
            <EventParam type="UINT64" name="pSet" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="pOSet" formatStr="0x%016llx"/>
        </EventDescription>
...
<EventDictionary>
    <EventClass key="sal" displayName="Socket Application Events" helpTopicId="VXWORKS6_SAL_CLASS_HELP">
        <EventDescription id="10096" name="EVENT_SAL_OPEN" hasTimeStamp="true"
            ...
            <EventParam type="UINT64" name="sockFd" formatStr="0x%llx"/>
        ...
        <EventDescription id="10099" name="EVENT_SALCREATE" hasTimeStamp="true"
            ...
            <EventParam type="UINT64" isSearchKey="true" name="serverId" formatStr="0x%016llx"/>
            <EventParam type="BLOB" name="name" formatStr="%s" />
        </EventDescription>
...
<EventDictionary>
    <EventClass key="sdLib" displayName="sdLib (Shared Data) Events" helpTopicId="VXWORKS6_SDLIB_CLASS_HELP">
        ...
        helpTopicId="VXWORKS6_EVENT_SD_CREATE_HELP" icon="images/sdCreate.gif">
            <EventParam type="UINT64" isSearchKey="true" name="sdId" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="options" formatStr="0x%llx"/>
            <EventParam type="UINT64" name="size" formatStr="0x%llx"/>
            <EventParam type="UINT64" name="attr" formatStr="0x%llx"/>
            <EventParam type="UINT64" name="virtAddr" formatStr="0x%016llx"/>
            <EventParam type="BLOB" name="name"/>
        </EventDescription>
        ...
        helpTopicId="VXWORKS6_EVENT_SD_MAP_HELP" icon="images/sdMap.gif">
            <EventParam type="UINT64" name="options" formatStr="0x%llx"/>
            <EventParam type="UINT64" name="attr" formatStr="0x%llx"/>
            <EventParam type="UINT64" isSearchKey="true" name="sdId"
            formatStr="0x%016llx"/>
        </EventDescription>
...
<EventDictionary>
    <EventClass displayName="syscall Events" helpTopicId="VXWORKS6_SYSCALL_CLASS_HELP" key="syscall">
        <EventDescription displayName="_exit" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._exit" id="21000" isSearchable="true" name="EVENT_SCN__exit" syscallIdent="8,0">
            <EventParam formatStr="%lld" name="status" type="UINT64"/>
        </EventDescription>
        <EventDescription displayName="_open" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._open" id="21001" isSearchable="true" name="EVENT_SCN__open" syscallIdent="8,2">
            <EventParam formatStr="0x%llx" name="name" type="UINT64"/>
            <EventParam formatStr="%lld" name="flags" type="UINT64"/>
            <EventParam formatStr="%lld" name="mode" type="UINT64"/>
        </EventDescription>
        <EventDescription displayName="_close" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._close" id="21002" isSearchable="true" name="EVENT_SCN__close" syscallIdent="8,3">
            <EventParam formatStr="%lld" name="fd" type="UINT64"/>
        </EventDescription>
        <EventDescription displayName="_read" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._read" id="21003" isSearchable="true" name="EVENT_SCN__read" syscallIdent="8,4">
            <EventParam formatStr="%lld" name="fd" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="buffer" type="UINT64"/>
            <EventParam formatStr="%lld" name="maxbytes" type="UINT64"/>
        </EventDescription>
        <EventDescription displayName="_write" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._write" id="21004" isSearchable="true" name="EVENT_SCN__write" syscallIdent="8,5">
            <EventParam formatStr="%lld" name="fd" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="buffer" type="UINT64"/>
            <EventParam formatStr="%lld" name="nbytes" type="UINT64"/>
        </EventDescription>
        <EventDescription displayName="_ioctl" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._ioctl" id="21005" isSearchable="true" name="EVENT_SCN__ioctl" syscallIdent="8,6">
            <EventParam formatStr="%lld" name="fd" type="UINT64"/>
            <EventParam formatStr="%lld" name="function" type="UINT64"/>
            <EventParam formatStr="%lld" name="arg" type="UINT64"/>
        </EventDescription>
        <EventDescription displayName="_dup" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._dup" id="21006" isSearchable="true" name="EVENT_SCN__dup" syscallIdent="8,7">
            <EventParam formatStr="%lld" name="fd" type="UINT64"/>
            <EventParam formatStr="%lld" name="startFd" type="UINT64"/>
        </EventDescription>
        <EventDescription displayName="_dup2" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._dup2" id="21007" isSearchable="true" name="EVENT_SCN__dup2" syscallIdent="8,8">
            <EventParam formatStr="%lld" name="fd" type="UINT64"/>
            <EventParam formatStr="%lld" name="fd2" type="UINT64"/>
        </EventDescription>
        <EventDescription displayName="_pipe" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._pipe" id="21008" isSearchable="true" name="EVENT_SCN__pipe" syscallIdent="8,9">
            <EventParam formatStr="0x%llx" name="fildes" type="UINT64"/>
            <EventParam formatStr="%lld" name="flags" type="UINT64"/>
        </EventDescription>
        ...
        <EventDescription displayName="_selectX" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._selectX" id="21010" isSearchable="true" name="EVENT_SCN__selectX" syscallIdent="8,11">
            <EventParam formatStr="%lld" name="width" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="readFds" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="writeFds" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="excFds" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="timeout" type="UINT64"/>
            <EventParam formatStr="%lld" name="clearSem" type="UINT64"/>
        </EventDescription>
        <EventDescription displayName="_socket" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._socket" id="21011" isSearchable="true" name="EVENT_SCN__socket" syscallIdent="8,12">
            <EventParam formatStr="%lld" name="domain" type="UINT64"/>
            <EventParam formatStr="%lld" name="type" type="UINT64"/>
            <EventParam formatStr="%lld" name="protocol" type="UINT64"/>
        </EventDescription>
        <EventDescription displayName="_bind" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._bind" id="21012" isSearchable="true" name="EVENT_SCN__bind" syscallIdent="8,13">
            <EventParam formatStr="%lld" name="s" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="name" type="UINT64"/>
            <EventParam formatStr="%lld" name="namelen" type="UINT64"/>
        </EventDescription>
        <EventDescription displayName="_listen" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._listen" id="21013" isSearchable="true" name="EVENT_SCN__listen" syscallIdent="8,14">
            <EventParam formatStr="%lld" name="s" type="UINT64"/>
            <EventParam formatStr="%lld" name="backlog" type="UINT64"/>
        </EventDescription>
        <EventDescription displayName="_accept" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._accept" id="21014" isSearchable="true" name="EVENT_SCN__accept" syscallIdent="8,15">
            <EventParam formatStr="%lld" name="s" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="addr" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="addrlen" type="UINT64"/>
        </EventDescription>
        ...
        <EventDescription displayName="_sendto" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._sendto" id="21016" isSearchable="true" name="EVENT_SCN__sendto" syscallIdent="8,17">
            <EventParam formatStr="%lld" name="s" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="buf" type="UINT64"/>
            <EventParam formatStr="%lld" name="bufLen" type="UINT64"/>
            <EventParam formatStr="%lld" name="flags" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="to" type="UINT64"/>
            <EventParam formatStr="%lld" name="tolen" type="UINT64"/>
        </EventDescription>
        ...
        <EventDescription displayName="_sendmsg" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._sendmsg" id="21018" isSearchable="true" name="EVENT_SCN__sendmsg" syscallIdent="8,19">
            <EventParam formatStr="%lld" name="s" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="mp" type="UINT64"/>
            <EventParam formatStr="%lld" name="flags" type="UINT64"/>
        </EventDescription>
        <EventDescription displayName="_recvfrom" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._recvfrom" id="21019" isSearchable="true" name="EVENT_SCN__recvfrom" syscallIdent="8,20">
            ...
            <EventParam formatStr="%lld" name="bufLen" type="UINT64"/>
            <EventParam formatStr="%lld" name="flags" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="from" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="pFromLen" type="UINT64"/>
        </EventDescription>
        ...
        <EventDescription displayName="_setsockopt" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._setsockopt" id="21022" isSearchable="true" name="EVENT_SCN__setsockopt" syscallIdent="8,23">
            <EventParam formatStr="%lld" name="s" type="UINT64"/>
            <EventParam formatStr="%lld" name="level" type="UINT64"/>
            <EventParam formatStr="%lld" name="optname" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="optval" type="UINT64"/>
            <EventParam formatStr="%lld" name="optlen" type="UINT64"/>
        </EventDescription>
        <EventDescription displayName="_getsockopt" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._getsockopt" id="21023" isSearchable="true" name="EVENT_SCN__getsockopt" syscallIdent="8,24">
            ...
            <EventParam formatStr="%lld" name="optname" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="optval" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="optlen" type="UINT64"/>
        </EventDescription>
        <EventDescription displayName="_getsockname" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._getsockname" id="21024" isSearchable="true" name="EVENT_SCN__getsockname" syscallIdent="8,25">
            <EventParam formatStr="%lld" name="s" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="name" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="namelen" type="UINT64"/>
        </EventDescription>
        ...
        <EventDescription displayName="_shutdown" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._shutdown" id="21026" isSearchable="true" name="EVENT_SCN__shutdown" syscallIdent="8,27">
            <EventParam formatStr="%lld" name="s" type="UINT64"/>
            <EventParam formatStr="%lld" name="how" type="UINT64"/>
        </EventDescription>
        <EventDescription displayName="mmap" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.mmap" id="21027" isSearchable="true" name="EVENT_SCN_mmap" syscallIdent="8,28">
            <EventParam formatStr="0x%llx" name="addr" type="UINT64"/>
            <EventParam formatStr="%lld" name="len" type="UINT64"/>
            <EventParam formatStr="%lld" name="prot" type="UINT64"/>
            <EventParam formatStr="%lld" name="flags" type="UINT64"/>
            <EventParam formatStr="%lld" name="fildes" type="UINT64"/>
            <EventParam formatStr="%lld" name="off" type="UINT64"/>
            <EventParam formatStr="%lld" name="Invalid_padding" type="UINT64"/>
            <EventParam formatStr="%lld" name="Invalid_padding" type="UINT64"/>
        </EventDescription>
        ...
        <EventDescription displayName="kill" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.kill" id="21030" isSearchable="true" name="EVENT_SCN_kill" syscallIdent="8,31">
            <EventParam formatStr="%lld" name="rtpId" type="UINT64"/>
            <EventParam formatStr="%lld" name="signo" type="UINT64"/>
        </EventDescription>
        ...
        <EventDescription displayName="sigpending" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.sigpending" id="21032" isSearchable="true" name="EVENT_SCN_sigpending" syscallIdent="8,33">
            <EventParam formatStr="0x%llx" name="pSet" type="UINT64"/>
        </EventDescription>
        <EventDescription displayName="sigprocmask" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.sigprocmask" id="21033" isSearchable="true" name="EVENT_SCN_sigprocmask" syscallIdent="8,34">
            <EventParam formatStr="%lld" name="how" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="pSet" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="pOset" type="UINT64"/>
        </EventDescription>
        <EventDescription displayName="_sigqueue" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._sigqueue" id="21034" isSearchable="true" name="EVENT_SCN__sigqueue" syscallIdent="8,35">
            <EventParam formatStr="%lld" name="rtpId" type="UINT64"/>
            <EventParam formatStr="%lld" name="signo" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="pValue" type="UINT64"/>
            <EventParam formatStr="%lld" name="sigCode" type="UINT64"/>
        </EventDescription>
        ...
        <EventDescription displayName="_sigtimedwait" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._sigtimedwait" id="21036" isSearchable="true" name="EVENT_SCN__sigtimedwait" syscallIdent="8,37">
            <EventParam formatStr="0x%llx" name="pSet" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="pInfo" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="pTime" type="UINT64"/>
        </EventDescription>
        <EventDescription displayName="_sigaction" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._sigaction" id="21037" isSearchable="true" name="EVENT_SCN__sigaction" syscallIdent="8,38">
            <EventParam formatStr="%lld" name="signo" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="pAct" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="pOact" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="retAddr" type="UINT64"/>
        </EventDescription>
        ...
        <EventDescription displayName="_getcwd" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._getcwd" id="21040" isSearchable="true" name="EVENT_SCN__getcwd" syscallIdent="8,41">
            <EventParam formatStr="0x%llx" name="buffer" type="UINT64"/>
            <EventParam formatStr="%lld" name="length" type="UINT64"/>
        </EventDescription>
        ...
        <EventDescription displayName="_waitpid" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._waitpid" id="21043" isSearchable="true" name="EVENT_SCN__waitpid" syscallIdent="8,45">
            <EventParam formatStr="%lld" name="childRtpId" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="pStatus" type="UINT64"/>
            <EventParam formatStr="%lld" name="options" type="UINT64"/>
        </EventDescription>
        <EventDescription displayName="sysctl" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.sysctl" id="21044" isSearchable="true" name="EVENT_SCN_sysctl" syscallIdent="8,46">
            <EventParam formatStr="0x%llx" name="pName" type="UINT64"/>
            <EventParam formatStr="%lld" name="nameLen" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="pOld" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="pOldLen" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="pNew" type="UINT64"/>
            <EventParam formatStr="%lld" name="newLen" type="UINT64"/>
        </EventDescription>
        <EventDescription displayName="_schedPxInfoGet" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._schedPxInfoGet" id="21045" isSearchable="true" name="EVENT_SCN__schedPxInfoGet" syscallIdent="8,47">
            <EventParam formatStr="0x%llx" name="pTimeSlicingOn" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="pTimeSlicePeriod" type="UINT64"/>
        </EventDescription>
        <EventDescription displayName="sigaltstack" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.sigaltstack" id="21046" isSearchable="true" name="EVENT_SCN_sigaltstack" syscallIdent="8,48">
            <EventParam formatStr="0x%llx" name="ss" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="oss" type="UINT64"/>
        </EventDescription>
        ...
        <EventDescription displayName="_link" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._link" id="21048" isSearchable="true" name="EVENT_SCN__link" syscallIdent="8,50">
            <EventParam formatStr="0x%llx" name="name" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="newname" type="UINT64"/>
        </EventDescription>
        ...
        <EventDescription displayName="_rename" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._rename" id="21051" isSearchable="true" name="EVENT_SCN__rename" syscallIdent="8,53">
            <EventParam formatStr="0x%llx" name="oldname" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="newname" type="UINT64"/>
        </EventDescription>
        <EventDescription displayName="_fpathconf" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._fpathconf" id="21052" isSearchable="true" name="EVENT_SCN__fpathconf" syscallIdent="8,54">
            <EventParam formatStr="%lld" name="fd" type="UINT64"/>
            <EventParam formatStr="%lld" name="name" type="UINT64"/>
        </EventDescription>
        <EventDescription displayName="_pathconf" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._pathconf" id="21053" isSearchable="true" name="EVENT_SCN__pathconf" syscallIdent="8,55">
            <EventParam formatStr="0x%llx" name="path" type="UINT64"/>
            <EventParam formatStr="%lld" name="name" type="UINT64"/>
        </EventDescription>
        <EventDescription displayName="_access" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._access" id="21054" isSearchable="true" name="EVENT_SCN__access" syscallIdent="8,56">
            <EventParam formatStr="0x%llx" name="path" type="UINT64"/>
            <EventParam formatStr="%lld" name="amode" type="UINT64"/>
        </EventDescription>
        ...
        <EventDescription displayName="pxTraceCreation" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.pxTraceCreation" id="21056" isSearchable="true" name="EVENT_SCN_pxTraceCreation" syscallIdent="8,58">
            <EventParam formatStr="%lld" name="cmd" type="UINT64"/>
            <EventParam formatStr="%lld" name="pid" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="attr" type="UINT64"/>
            <EventParam formatStr="%lld" name="fd" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="trid" type="UINT64"/>
        </EventDescription>
        <EventDescription displayName="pxTraceCtl" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.pxTraceCtl" id="21057" isSearchable="true" name="EVENT_SCN_pxTraceCtl" syscallIdent="8,59">
            <EventParam formatStr="%lld" name="cmd" type="UINT64"/>
            <EventParam formatStr="%lld" name="trid" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="filter" type="UINT64"/>
            <EventParam formatStr="%lld" name="how" type="UINT64"/>
            <EventParam formatStr="%lld" name="thread_id" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="pc" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="ptr_out" type="UINT64"/>
        </EventDescription>
        <EventDescription displayName="pxTraceEvent" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.pxTraceEvent" id="21058" isSearchable="true" name="EVENT_SCN_pxTraceEvent" syscallIdent="8,60">
            <EventParam formatStr="%lld" name="cmd" type="UINT64"/>
            <EventParam formatStr="%lld" name="id_in" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="data" type="UINT64"/>
            <EventParam formatStr="%lld" name="data_len" type="UINT64"/>
            <EventParam formatStr="%lld" name="thread_id" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="pc" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="id_out" type="UINT64"/>
        </EventDescription>
        <EventDescription displayName="pxTraceEventNameQuery" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.pxTraceEventNameQuery" id="21059" isSearchable="true" name="EVENT_SCN_pxTraceEventNameQuery" syscallIdent="8,61">
            <EventParam formatStr="%lld" name="cmd" type="UINT64"/>
            <EventParam formatStr="%lld" name="trid" type="UINT64"/>
            <EventParam formatStr="%lld" name="id_in1" type="UINT64"/>
            <EventParam formatStr="%lld" name="id_in2" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="name" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="id_out" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="unavailable" type="UINT64"/>
        </EventDescription>
        <EventDescription displayName="pxTraceLog" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.pxTraceLog" id="21060" isSearchable="true" name="EVENT_SCN_pxTraceLog" syscallIdent="8,62">
            <EventParam formatStr="%lld" name="cmd" type="UINT64"/>
            <EventParam formatStr="%lld" name="trid_in" type="UINT64"/>
            <EventParam formatStr="%lld" name="fd" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="trid_out" type="UINT64"/>
        </EventDescription>
        <EventDescription displayName="pxTraceEventGet" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.pxTraceEventGet" id="21061" isSearchable="true" name="EVENT_SCN_pxTraceEventGet" syscallIdent="8,63">
            <EventParam formatStr="%lld" name="cmd" type="UINT64"/>
            <EventParam formatStr="%lld" name="trid" type="UINT64"/>
            <EventParam formatStr="%lld" name="num_bytes" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="timeout" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="event" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="data" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="data_len" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="unavailable" type="UINT64"/>
        </EventDescription>
        <EventDescription displayName="eventReceiveEx" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.eventReceiveEx" id="21062" isSearchable="true" name="EVENT_SCN_eventReceiveEx" syscallIdent="9,0">
            <EventParam formatStr="%lld" name="events" type="UINT64"/>
            <EventParam formatStr="%lld" name="options" type="UINT64"/>
            <EventParam formatStr="%lld" name="timeout" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="pEvtsReceived" type="UINT64"/>
        </EventDescription>
        <EventDescription displayName="eventSend" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.eventSend" id="21063" isSearchable="true" name="EVENT_SCN_eventSend" syscallIdent="9,1">
            <EventParam formatStr="%lld" name="taskId" type="UINT64"/>
            <EventParam formatStr="%lld" name="events" type="UINT64"/>
        </EventDescription>
        <EventDescription displayName="eventCtl" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.eventCtl" id="21064" isSearchable="true" name="EVENT_SCN_eventCtl" syscallIdent="9,2">
            <EventParam formatStr="%lld" name="handle" type="UINT64"/>
            <EventParam formatStr="%lld" name="command" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="pArg" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="pArgSize" type="UINT64"/>
        </EventDescription>
        <EventDescription displayName="_msgQSend" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._msgQSend" id="21065" isSearchable="true" name="EVENT_SCN__msgQSend" syscallIdent="9,3">
            ...
            <EventParam formatStr="%lld" name="nBytes" type="UINT64"/>
            <EventParam formatStr="%lld" name="timeout" type="UINT64"/>
            <EventParam formatStr="%lld" name="priority" type="UINT64"/>
        </EventDescription>
        <EventDescription displayName="_msgQReceive" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._msgQReceive" id="21066" isSearchable="true" name="EVENT_SCN__msgQReceive" syscallIdent="9,4">
            <EventParam formatStr="%lld" name="handle" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="buffer" type="UINT64"/>
            <EventParam formatStr="%lld" name="maxNBytes" type="UINT64"/>
            <EventParam formatStr="%lld" name="timeout" type="UINT64"/>
        </EventDescription>
        <EventDescription displayName="_msgQOpen" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._msgQOpen" id="21067" isSearchable="true" name="EVENT_SCN__msgQOpen" syscallIdent="9,5">
            <EventParam formatStr="0x%llx" name="name" type="UINT64"/>
            <EventParam formatStr="%lld" name="maxMsgs" type="UINT64"/>
            <EventParam formatStr="%lld" name="maxMsgLength" type="UINT64"/>
            <EventParam formatStr="%lld" name="options" type="UINT64"/>
            <EventParam formatStr="%lld" name="mode" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="context" type="UINT64"/>
        </EventDescription>
        ...
        <EventDescription displayName="objInfoGet" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.objInfoGet" id="21069" isSearchable="true" name="EVENT_SCN_objInfoGet" syscallIdent="9,7">
            <EventParam formatStr="%lld" name="handle" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="pInfo" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="pInfoSize" type="UINT64"/>
            <EventParam formatStr="%lld" name="level" type="UINT64"/>
        </EventDescription>
        ...
        <EventDescription displayName="_semOpen" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._semOpen" id="21072" isSearchable="true" name="EVENT_SCN__semOpen" syscallIdent="9,10">
            <EventParam formatStr="0x%llx" name="name" type="UINT64"/>
            <EventParam formatStr="%lld" name="type" type="UINT64"/>
            <EventParam formatStr="%lld" name="initState" type="UINT64"/>
            <EventParam formatStr="%lld" name="options" type="UINT64"/>
            <EventParam formatStr="%lld" name="mode" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="context" type="UINT64"/>
        </EventDescription>
        <EventDescription displayName="_taskOpen" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._taskOpen" id="21074" isSearchable="true" name="EVENT_SCN__taskOpen" syscallIdent="9,12">
            <EventParam formatStr="0x%llx" name="pArgs" type="UINT64"/>
        </EventDescription>
        <EventDescription displayName="_taskDelay" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._taskDelay" id="21075" isSearchable="true" name="EVENT_SCN__taskDelay" syscallIdent="9,14">
            <EventParam formatStr="%lld" name="ticks" type="UINT64"/>
        </EventDescription>
        <EventDescription displayName="rtpSpawn" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.rtpSpawn" id="21076" isSearchable="true" name="EVENT_SCN_rtpSpawn" syscallIdent="9,15">
            <EventParam formatStr="0x%llx" name="rtpFileName" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="argv" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="envp" type="UINT64"/>
            <EventParam formatStr="%lld" name="priority" type="UINT64"/>
            <EventParam formatStr="%lld" name="uStackSize" type="UINT64"/>
            <EventParam formatStr="%lld" name="options" type="UINT64"/>
            <EventParam formatStr="%lld" name="taskOptions" type="UINT64"/>
        </EventDescription>
        <EventDescription displayName="rtpInfoGet" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.rtpInfoGet" id="21077" isSearchable="true" name="EVENT_SCN_rtpInfoGet" syscallIdent="9,16">
            <EventParam formatStr="%lld" name="rtpId" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="rtpStruct" type="UINT64"/>
        </EventDescription>
        <EventDescription displayName="taskKill" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.taskKill" id="21078" isSearchable="true" name="EVENT_SCN_taskKill" syscallIdent="9,17">
            <EventParam formatStr="%lld" name="taskHandle" type="UINT64"/>
            <EventParam formatStr="%lld" name="signo" type="UINT64"/>
        </EventDescription>
        ...
        <EventDescription displayName="_timer_open" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._timer_open" id="21080" isSearchable="true" name="EVENT_SCN__timer_open" syscallIdent="9,19">
            <EventParam formatStr="0x%llx" name="name" type="UINT64"/>
            <EventParam formatStr="%lld" name="mode" type="UINT64"/>
            <EventParam formatStr="%lld" name="clockId" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="evp" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="context" type="UINT64"/>
        </EventDescription>
        <EventDescription displayName="timerCtl" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.timerCtl" id="21081" isSearchable="true" name="EVENT_SCN_timerCtl" syscallIdent="9,20">
            <EventParam formatStr="%lld" name="cmdCode" type="UINT64"/>
            <EventParam formatStr="%lld" name="timerHandle" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="pArgs" type="UINT64"/>
            <EventParam formatStr="%lld" name="pArgSize" type="UINT64"/>
        </EventDescription>
        <EventDescription displayName="pxOpen" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.pxOpen" id="21082" isSearchable="true" name="EVENT_SCN_pxOpen" syscallIdent="9,21">
            <EventParam formatStr="%lld" name="type" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="name" type="UINT64"/>
            <EventParam formatStr="%lld" name="objOpenMode" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="attr" type="UINT64"/>
        </EventDescription>
        ...
        <EventDescription displayName="pxMqReceive" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.pxMqReceive" id="21086" isSearchable="true" name="EVENT_SCN_pxMqReceive" syscallIdent="9,25">
            <EventParam formatStr="%lld" name="handle" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="pMsg" type="UINT64"/>
            <EventParam formatStr="%lld" name="msgLen" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="pMsgPrio" type="UINT64"/>
            <EventParam formatStr="%lld" name="waitOption" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="time_out" type="UINT64"/>
        </EventDescription>
        <EventDescription displayName="pxMqSend" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.pxMqSend" id="21087" isSearchable="true" name="EVENT_SCN_pxMqSend" syscallIdent="9,26">
            ...
            <EventParam formatStr="0x%llx" name="pMsg" type="UINT64"/>
            <EventParam formatStr="%lld" name="msgLen" type="UINT64"/>
            <EventParam formatStr="%lld" name="msgPrio" type="UINT64"/>
            <EventParam formatStr="%lld" name="waitOption" type="UINT64"/>
            <EventParam formatStr="0x%llx" name="time_out" type="UINT64"/>
        </EventDescription>
    ...
    <EventDictionary>
        <EventClass displayName="syscall Events" helpTopicId="VXWORKS6_SYSCALL_CLASS_HELP" key="syscall">
            ...
            <EventDescription displayName="pipeDevCreate" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.pipeDevCreate" id="21090" isSearchable="true" name="EVENT_SCN_pipeDevCreate" syscallIdent="9,29">
                <EventParam formatStr="0x%llx" name="name" type="UINT64"/>
                <EventParam formatStr="%lld" name="nMessages" type="UINT64"/>
                <EventParam formatStr="%lld" name="nBytes" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="pipeDevDelete" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.pipeDevDelete" id="21091" isSearchable="true" name="EVENT_SCN_pipeDevDelete" syscallIdent="9,30">
                <EventParam formatStr="0x%llx" name="name" type="UINT64"/>
                <EventParam formatStr="%lld" name="force" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="_sdCreate" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._sdCreate" id="21092" isSearchable="true" name="EVENT_SCN__sdCreate" syscallIdent="9,31">
                <EventParam formatStr="0x%llx" name="name" type="UINT64"/>
                <EventParam formatStr="%lld" name="options" type="UINT64"/>
                <EventParam formatStr="%lld" name="size" type="UINT64"/>
                <EventParam formatStr="%lld" name="physAddress" type="UINT64"/>
                <EventParam formatStr="%lld" name="attr" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pVirtAddress" type="UINT64"/>
                <EventParam formatStr="%lld" name="Invalid_padding" type="UINT64"/>
                <EventParam formatStr="%lld" name="Invalid_padding" type="UINT64"/>
            </EventDescription>
            ...
            <EventDescription displayName="_edrErrorInject" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._edrErrorInject" id="21098" isSearchable="true" name="EVENT_SCN__edrErrorInject" syscallIdent="9,37">
                <EventParam formatStr="%lld" name="kind" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="fileName" type="UINT64"/>
                <EventParam formatStr="%lld" name="lineNumber" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="regset" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="addr" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="msg" type="UINT64"/>
            </EventDescription>
            ...
            <EventDescription displayName="wvEvent" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.wvEvent" id="21100" isSearchable="true" name="EVENT_SCN_wvEvent" syscallIdent="9,40">
                <EventParam formatStr="%lld" name="eventId" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pData" type="UINT64"/>
                <EventParam formatStr="%lld" name="dataSize" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="rtpVarAdd" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.rtpVarAdd" id="21101" isSearchable="true" name="EVENT_SCN_rtpVarAdd" syscallIdent="9,41">
                <EventParam formatStr="0x%llx" name="pVar" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="value" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="sdInfoGet" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.sdInfoGet" id="21102" isSearchable="true" name="EVENT_SCN_sdInfoGet" syscallIdent="9,42">
                <EventParam formatStr="%lld" name="handle" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pSdStruct" type="UINT64"/>
            </EventDescription>
            ...
            <EventDescription displayName="_shlUnlock" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._shlUnlock" id="21104" isSearchable="true" name="EVENT_SCN__shlUnlock" syscallIdent="9,44">
                <EventParam formatStr="%lld" name="shlId" type="UINT64"/>
            </EventDescription>
            ...
            <EventDescription displayName="objUnlink" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.objUnlink" id="21108" isSearchable="true" name="EVENT_SCN_objUnlink" syscallIdent="9,48">
                <EventParam formatStr="0x%llx" name="name" type="UINT64"/>
                <EventParam formatStr="%lld" name="classType" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="getprlimit" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.getprlimit" id="21109" isSearchable="true" name="EVENT_SCN_getprlimit" syscallIdent="9,49">
                <EventParam formatStr="%lld" name="idtype" type="UINT64"/>
                <EventParam formatStr="%lld" name="handle" type="UINT64"/>
                <EventParam formatStr="%lld" name="resource" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="rlp" type="UINT64"/>
            </EventDescription>
            ...
            <EventDescription displayName="_mctl" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._mctl" id="21111" isSearchable="true" name="EVENT_SCN__mctl" syscallIdent="9,51">
                ...
                <EventParam formatStr="%lld" name="len" type="UINT64"/>
                <EventParam formatStr="%lld" name="function" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="arg" type="UINT64"/>
            </EventDescription>
            ...
            <EventDescription displayName="clockCtl" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.clockCtl" id="21113" isSearchable="true" name="EVENT_SCN_clockCtl" syscallIdent="9,53">
                <EventParam formatStr="%lld" name="clock_id" type="UINT64"/>
                <EventParam formatStr="%lld" name="cmdCode" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pArgStruct" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pArgSize" type="UINT64"/>
            </EventDescription>
            ...
            <EventDescription displayName="_semExchange" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._semExchange" id="21116" isSearchable="true" name="EVENT_SCN__semExchange" syscallIdent="9,56">
                <EventParam formatStr="%lld" name="giveHandle" type="UINT64"/>
                <EventParam formatStr="%lld" name="takeHandle" type="UINT64"/>
                <EventParam formatStr="%lld" name="timeout" type="UINT64"/>
            </EventDescription>
            ...
            <EventDescription displayName="_condVarWait" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._condVarWait" id="21120" isSearchable="true" name="EVENT_SCN__condVarWait" syscallIdent="9,60">
                <EventParam formatStr="%lld" name="handle" type="UINT64"/>
                <EventParam formatStr="%lld" name="mtx_handle" type="UINT64"/>
                <EventParam formatStr="%lld" name="timeout" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="_condVarSignal" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._condVarSignal" id="21121" isSearchable="true" name="EVENT_SCN__condVarSignal" syscallIdent="9,61">
                <EventParam formatStr="%lld" name="handle" type="UINT64"/>
                <EventParam formatStr="%lld" name="broadcast" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="userAuthenticate" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.userAuthenticate" id="21122" isSearchable="true" name="EVENT_SCN_userAuthenticate" syscallIdent="9,62">
                <EventParam formatStr="0x%llx" name="loginName" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="clearPassword" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pUserId" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pGroupId" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="userPasswordUpdate" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.userPasswordUpdate" id="21123" isSearchable="true" name="EVENT_SCN_userPasswordUpdate" syscallIdent="9,63">
                <EventParam formatStr="0x%llx" name="loginName" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="oldClearPassword" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="newClearPassword" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="_getpwuid" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._getpwuid" id="21124" isSearchable="true" name="EVENT_SCN__getpwuid" syscallIdent="15,0">
                <EventParam formatStr="%lld" name="userId" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pwd" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="buffer" type="UINT64"/>
                <EventParam formatStr="%lld" name="bufsize" type="UINT64"/>
            </EventDescription>
            ...
            <EventDescription displayName="_setuid" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._setuid" id="21126" isSearchable="true" name="EVENT_SCN__setuid" syscallIdent="15,2">
                <EventParam formatStr="%lld" name="uid" type="UINT64"/>
            </EventDescription>
            ...
            <EventDescription displayName="_setgid" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._setgid" id="21128" isSearchable="true" name="EVENT_SCN__setgid" syscallIdent="15,4">
                <EventParam formatStr="%lld" name="gid" type="UINT64"/>
            </EventDescription>
            ...
            <EventDescription displayName="_seteuid" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._seteuid" id="21130" isSearchable="true" name="EVENT_SCN__seteuid" syscallIdent="15,6">
                <EventParam formatStr="%lld" name="euid" type="UINT64"/>
            </EventDescription>
            ...
            <EventDescription displayName="_setegid" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._setegid" id="21132" isSearchable="true" name="EVENT_SCN__setegid" syscallIdent="15,8">
                <EventParam formatStr="%lld" name="egid" type="UINT64"/>
            </EventDescription>
            ...
            <EventDescription displayName="getlogin_r" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.getlogin_r" id="21134" isSearchable="true" name="EVENT_SCN_getlogin_r" syscallIdent="15,10">
                <EventParam formatStr="0x%llx" name="loginName" type="UINT64"/>
                <EventParam formatStr="%lld" name="nameSz" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="_clock_getres" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._clock_getres" id="21135" isSearchable="true" name="EVENT_SCN__clock_getres" syscallIdent="15,11">
                <EventParam formatStr="%lld" name="clock_id" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="res" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="_clock_gettime" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._clock_gettime" id="21136" isSearchable="true" name="EVENT_SCN__clock_gettime" syscallIdent="15,12">
                <EventParam formatStr="%lld" name="clock_id" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="tp" type="UINT64"/>
            </EventDescription>
            ...
            <EventDescription displayName="_umask" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._umask" id="21138" isSearchable="true" name="EVENT_SCN__umask" syscallIdent="15,14">
                <EventParam formatStr="%lld" name="cmask" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="_sigtimedwait2" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._sigtimedwait2" id="21139" isSearchable="true" name="EVENT_SCN__sigtimedwait2" syscallIdent="15,15">
                ...
                <EventParam formatStr="0x%llx" name="pInfo" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pTime" type="UINT64"/>
                <EventParam formatStr="%lld" name="version" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="_posix_spawn" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._posix_spawn" id="21140" isSearchable="true" name="EVENT_SCN__posix_spawn" syscallIdent="15,16">
                <EventParam formatStr="0x%llx" name="pPid" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="path" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pFile_actions" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pPxSpawnAttr" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="argv" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="envp" type="UINT64"/>
            </EventDescription>
            ...
            <EventDescription displayName="randNumGenCtl" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.randNumGenCtl" id="21144" isSearchable="true" name="EVENT_SCN_randNumGenCtl" syscallIdent="16,0">
                <EventParam formatStr="%lld" name="command" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pArg" type="UINT64"/>
                <EventParam formatStr="%lld" name="pArgSize" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="taskStateCtl" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.taskStateCtl" id="21145" isSearchable="true" name="EVENT_SCN_taskStateCtl" syscallIdent="16,1">
                <EventParam formatStr="%lld" name="tid" type="UINT64"/>
                <EventParam formatStr="%lld" name="command" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pArg" type="UINT64"/>
                <EventParam formatStr="%lld" name="argSize" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="taskParamCtl" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.taskParamCtl" id="21146" isSearchable="true" name="EVENT_SCN_taskParamCtl" syscallIdent="16,2">
                <EventParam formatStr="%lld" name="tid" type="UINT64"/>
                <EventParam formatStr="%lld" name="command" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pArg" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="taskPriCtl" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.taskPriCtl" id="21147" isSearchable="true" name="EVENT_SCN_taskPriCtl" syscallIdent="16,3">
                <EventParam formatStr="%lld" name="tid" type="UINT64"/>
                <EventParam formatStr="%lld" name="command" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pArg" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="taskCpuAffCtl" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.taskCpuAffCtl" id="21148" isSearchable="true" name="EVENT_SCN_taskCpuAffCtl" syscallIdent="16,4">
                <EventParam formatStr="%lld" name="tid" type="UINT64"/>
                <EventParam formatStr="%lld" name="command" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pArg" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="taskVarCtl" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.taskVarCtl" id="21149" isSearchable="true" name="EVENT_SCN_taskVarCtl" syscallIdent="16,5">
                <EventParam formatStr="%lld" name="tid" type="UINT64"/>
                <EventParam formatStr="%lld" name="command" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pVar" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pValue" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="taskPxAttrCtl" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.taskPxAttrCtl" id="21150" isSearchable="true" name="EVENT_SCN_taskPxAttrCtl" syscallIdent="16,6">
                <EventParam formatStr="%lld" name="tid" type="UINT64"/>
                <EventParam formatStr="%lld" name="command" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pArg" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="_taskWait" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._taskWait" id="21151" isSearchable="true" name="EVENT_SCN__taskWait" syscallIdent="16,7">
                <EventParam formatStr="%lld" name="tid" type="UINT64"/>
                <EventParam formatStr="%lld" name="timeout" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="atomic32Op" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.atomic32Op" id="21152" isSearchable="true" name="EVENT_SCN_atomic32Op" syscallIdent="16,8">
                <EventParam formatStr="0x%llx" name="target" type="UINT64"/>
                <EventParam formatStr="%lld" name="oldValue" type="UINT64"/>
                <EventParam formatStr="%lld" name="value" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="returnVal" type="UINT64"/>
                <EventParam formatStr="%lld" name="atomicSwitch" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="atomic64Op" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.atomic64Op" id="21153" isSearchable="true" name="EVENT_SCN_atomic64Op" syscallIdent="16,9">
                <EventParam formatStr="0x%llx" name="target" type="UINT64"/>
                <EventParam formatStr="%lld" name="oldValue" type="UINT64"/>
                <EventParam formatStr="%lld" name="value" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="returnVal" type="UINT64"/>
            ...
            <EventDescription displayName="_rtpTaskExitRegister" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._rtpTaskExitRegister" id="21154" isSearchable="true" name="EVENT_SCN__rtpTaskExitRegister" syscallIdent="16,10">
                <EventParam formatStr="0x%llx" name="funcPtr" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="vxSysInfoGet" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.vxSysInfoGet" id="21155" isSearchable="true" name="EVENT_SCN_vxSysInfoGet" syscallIdent="16,11">
                <EventParam formatStr="0x%llx" name="pVxSysInfo" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="_tick64Get" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._tick64Get" id="21156" isSearchable="true" name="EVENT_SCN__tick64Get" syscallIdent="16,12">
                <EventParam formatStr="0x%llx" name="pTickVal" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="tickRateGet" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.tickRateGet" id="21157" isSearchable="true" name="EVENT_SCN_tickRateGet" syscallIdent="16,13"/>
            <EventDescription displayName="shmVolNameGet" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.shmVolNameGet" id="21158" isSearchable="true" name="EVENT_SCN_shmVolNameGet" syscallIdent="16,14">
                <EventParam formatStr="0x%llx" name="name" type="UINT64"/>
                <EventParam formatStr="%lld" name="len" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="_selWakeupOp" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._selWakeupOp" id="21159" isSearchable="true" name="EVENT_SCN__selWakeupOp" syscallIdent="16,15">
                <EventParam formatStr="%lld" name="tid" type="UINT64"/>
                <EventParam formatStr="%lld" name="op" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="_umiosFdGet" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._umiosFdGet" id="21160" isSearchable="true" name="EVENT_SCN__umiosFdGet" syscallIdent="16,16"/>
            <EventDescription displayName="_pipeAnonCreate" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._pipeAnonCreate" id="21161" isSearchable="true" name="EVENT_SCN__pipeAnonCreate" syscallIdent="16,17">
                <EventParam formatStr="%lld" name="nMessages" type="UINT64"/>
                <EventParam formatStr="%lld" name="nBytes" type="UINT64"/>
                <EventParam formatStr="%lld" name="flags" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pFd" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="taskDelayEx" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.taskDelayEx" id="21162" isSearchable="true" name="EVENT_SCN_taskDelayEx" syscallIdent="16,18">
                <EventParam formatStr="%lld" name="ticks" type="UINT64"/>
                <EventParam formatStr="%lld" name="flags" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="clock_getinfo" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.clock_getinfo" id="21163" isSearchable="true" name="EVENT_SCN_clock_getinfo" syscallIdent="16,19">
                <EventParam formatStr="%lld" name="clock_id" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="clk_info" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="_pathIsAbsolute" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._pathIsAbsolute" id="21164" isSearchable="true" name="EVENT_SCN__pathIsAbsolute" syscallIdent="16,20">
                <EventParam formatStr="0x%llx" name="name" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pNameTail" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="_realpath" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._realpath" id="21165" isSearchable="true" name="EVENT_SCN__realpath" syscallIdent="16,21">
                <EventParam formatStr="0x%llx" name="fileName" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="resolvedName" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="_dupX" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._dupX" id="21166" isSearchable="true" name="EVENT_SCN__dupX" syscallIdent="16,22">
                <EventParam formatStr="%lld" name="fd" type="UINT64"/>
                <EventParam formatStr="%lld" name="startFd" type="UINT64"/>
                <EventParam formatStr="%lld" name="fdFlags" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="_semMTakeByProxy" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._semMTakeByProxy" id="21167" isSearchable="true" name="EVENT_SCN__semMTakeByProxy" syscallIdent="16,23">
                <EventParam formatStr="%lld" name="handle" type="UINT64"/>
                <EventParam formatStr="%lld" name="semOwnerTaskId" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="semOwnerGet" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.semOwnerGet" id="21168" isSearchable="true" name="EVENT_SCN_semOwnerGet" syscallIdent="16,24">
                <EventParam formatStr="%lld" name="handle" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pSemOwner" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="_semFlush" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._semFlush" id="21169" isSearchable="true" name="EVENT_SCN__semFlush" syscallIdent="16,25">
                <EventParam formatStr="%lld" name="handle" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="semMTakeHard" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.semMTakeHard" id="21170" isSearchable="true" name="EVENT_SCN_semMTakeHard" syscallIdent="16,26">
                <EventParam formatStr="%lld" name="handle" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pUserSemOwner" type="UINT64"/>
                <EventParam formatStr="%lld" name="timeout" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="semMGiveHard" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.semMGiveHard" id="21171" isSearchable="true" name="EVENT_SCN_semMGiveHard" syscallIdent="16,27">
                <EventParam formatStr="%lld" name="handle" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pUserSemOwner" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pSendEvents" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="semUserExchange" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.semUserExchange" id="21172" isSearchable="true" name="EVENT_SCN_semUserExchange" syscallIdent="16,28">
                <EventParam formatStr="%lld" name="handle" type="UINT64"/>
                <EventParam formatStr="%lld" name="takeSemId" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pUserGiveSemOwner" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pUserTakeSemOwner" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pSendEvents" type="UINT64"/>
                <EventParam formatStr="%lld" name="timeout" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="_vxeAbsPathGet" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._vxeAbsPathGet" id="21173" isSearchable="true" name="EVENT_SCN__vxeAbsPathGet" syscallIdent="16,29">
                <EventParam formatStr="%lld" name="rtpId" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="path" type="UINT64"/>
                <EventParam formatStr="%lld" name="pathlen" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="envAccess" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.envAccess" id="21174" isSearchable="true" name="EVENT_SCN_envAccess" syscallIdent="16,30">
                <EventParam formatStr="0x%llx" name="valsize" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="valueBuf" type="UINT64"/>
                <EventParam formatStr="%lld" name="valBufSize" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="name" type="UINT64"/>
                <EventParam formatStr="%lld" name="namelen" type="UINT64"/>
                <EventParam formatStr="%lld" name="extFlags" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="_semUBTake" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._semUBTake" id="21175" isSearchable="true" name="EVENT_SCN__semUBTake" syscallIdent="16,31">
                <EventParam formatStr="%lld" name="handle" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pSemUBState" type="UINT64"/>
                <EventParam formatStr="%lld" name="timeout" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="_semUBGive" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._semUBGive" id="21176" isSearchable="true" name="EVENT_SCN__semUBGive" syscallIdent="16,32">
                <EventParam formatStr="%lld" name="handle" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pSemUBState" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pSendEvents" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="vxnsCreate" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.vxnsCreate" id="21177" isSearchable="true" name="EVENT_SCN_vxnsCreate" syscallIdent="16,33">
                <EventParam formatStr="%lld" name="nsFlags" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="vxnsCtl" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.vxnsCtl" id="21178" isSearchable="true" name="EVENT_SCN_vxnsCtl" syscallIdent="16,34">
                <EventParam formatStr="%lld" name="handle" type="UINT64"/>
                <EventParam formatStr="%lld" name="command" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="arg" type="UINT64"/>
                <EventParam formatStr="%lld" name="argSize" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="clock_getinfo2" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.clock_getinfo2" id="21179" isSearchable="true" name="EVENT_SCN_clock_getinfo2" syscallIdent="16,35">
                <EventParam formatStr="%lld" name="clock_id" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="clk_info" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="_realpath2" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._realpath2" id="21180" isSearchable="true" name="EVENT_SCN__realpath2" syscallIdent="16,36">
                <EventParam formatStr="0x%llx" name="fileName" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="resolvedName" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="_semMConsistent" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._semMConsistent" id="21181" isSearchable="true" name="EVENT_SCN__semMConsistent" syscallIdent="16,37">
                <EventParam formatStr="%lld" name="handle" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="_semUCTake" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._semUCTake" id="21182" isSearchable="true" name="EVENT_SCN__semUCTake" syscallIdent="16,38">
                <EventParam formatStr="%lld" name="handle" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pSemUCCount" type="UINT64"/>
                <EventParam formatStr="%lld" name="timeout" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="_semUCGive" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._semUCGive" id="21183" isSearchable="true" name="EVENT_SCN__semUCGive" syscallIdent="16,39">
                <EventParam formatStr="%lld" name="handle" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pSemUCCount" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pSendEvents" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="_oioctl" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._oioctl" id="21184" isSearchable="true" name="EVENT_SCN__oioctl" syscallIdent="16,40">
                <EventParam formatStr="0x%llx" name="name" type="UINT64"/>
                <EventParam formatStr="%lld" name="openFlags" type="UINT64"/>
                <EventParam formatStr="%lld" name="openMode" type="UINT64"/>
                <EventParam formatStr="%lld" name="function" type="UINT64"/>
                <EventParam formatStr="%lld" name="arg" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="_msgQUSend" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._msgQUSend" id="21185" isSearchable="true" name="EVENT_SCN__msgQUSend" syscallIdent="16,41">
                <EventParam formatStr="%lld" name="handle" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="buffer" type="UINT64"/>
                <EventParam formatStr="%lld" name="nBytes" type="UINT64"/>
                <EventParam formatStr="%lld" name="timeout" type="UINT64"/>
                <EventParam formatStr="%lld" name="priority" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pMsgQUState" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pSendEvents" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="_msgQUReceive" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._msgQUReceive" id="21186" isSearchable="true" name="EVENT_SCN__msgQUReceive" syscallIdent="16,42">
                <EventParam formatStr="%lld" name="handle" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="buffer" type="UINT64"/>
                <EventParam formatStr="%lld" name="maxNBytes" type="UINT64"/>
                <EventParam formatStr="%lld" name="timeout" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pMsgQUState" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pUMsgLength" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="_pxMqUReceive" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._pxMqUReceive" id="21187" isSearchable="true" name="EVENT_SCN__pxMqUReceive" syscallIdent="16,43">
                <EventParam formatStr="%lld" name="handle" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pMsg" type="UINT64"/>
                <EventParam formatStr="%lld" name="msgLen" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pMsgPrio" type="UINT64"/>
                <EventParam formatStr="%lld" name="waitOption" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="time_out" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pMsgQUStatePrio" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pUMsgLength" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="_pxMqUSend" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc._pxMqUSend" id="21188" isSearchable="true" name="EVENT_SCN__pxMqUSend" syscallIdent="16,44">
                <EventParam formatStr="%lld" name="handle" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pMsg" type="UINT64"/>
                <EventParam formatStr="%lld" name="msgLen" type="UINT64"/>
                <EventParam formatStr="%lld" name="msgPrio" type="UINT64"/>
            ...
            <EventDescription displayName="apexQueuingPortCreate" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.apexQueuingPortCreate" id="21189" isSearchable="true" name="EVENT_SCN_apexQueuingPortCreate" syscallIdent="17,0">
                <EventParam formatStr="0x%llx" name="qPortName" type="UINT64"/>
                <EventParam formatStr="%lld" name="maxMsgSize" type="UINT64"/>
                <EventParam formatStr="%lld" name="maxNumMsg" type="UINT64"/>
                <EventParam formatStr="%lld" name="direction" type="UINT64"/>
                <EventParam formatStr="%lld" name="discipline" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pObjPortHandle" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="apexQueuingPortSend" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.apexQueuingPortSend" id="21190" isSearchable="true" name="EVENT_SCN_apexQueuingPortSend" syscallIdent="17,1">
                <EventParam formatStr="%lld" name="objPortHandle" type="UINT64"/>
                <EventParam formatStr="%lld" name="msgAddr" type="UINT64"/>
                <EventParam formatStr="%lld" name="msgLen" type="UINT64"/>
                <EventParam formatStr="%lld" name="timeout" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="apexQueuingPortReceive" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.apexQueuingPortReceive" id="21191" isSearchable="true" name="EVENT_SCN_apexQueuingPortReceive" syscallIdent="17,2">
                <EventParam formatStr="%lld" name="objPortHandle" type="UINT64"/>
                <EventParam formatStr="%lld" name="timeout" type="UINT64"/>
                <EventParam formatStr="%lld" name="msgAddr" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pMsgLen" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="apexQueuingPortIdGet" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.apexQueuingPortIdGet" id="21192" isSearchable="true" name="EVENT_SCN_apexQueuingPortIdGet" syscallIdent="17,3">
                <EventParam formatStr="0x%llx" name="qPortName" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pObjPortHandle" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="apexQueuingPortStatusGet" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.apexQueuingPortStatusGet" id="21193" isSearchable="true" name="EVENT_SCN_apexQueuingPortStatusGet" syscallIdent="17,4">
                <EventParam formatStr="%lld" name="objPortHandle" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="portStatus" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="apexQueuingPortClear" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.apexQueuingPortClear" id="21194" isSearchable="true" name="EVENT_SCN_apexQueuingPortClear" syscallIdent="17,5">
                <EventParam formatStr="%lld" name="objPortHandle" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="apexSamplingPortCreate" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.apexSamplingPortCreate" id="21195" isSearchable="true" name="EVENT_SCN_apexSamplingPortCreate" syscallIdent="17,6">
                <EventParam formatStr="0x%llx" name="sPortName" type="UINT64"/>
                <EventParam formatStr="%lld" name="maxMsgSize" type="UINT64"/>
                <EventParam formatStr="%lld" name="direction" type="UINT64"/>
                <EventParam formatStr="%lld" name="refreshPeriod" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pObjPortHandle" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="apexSamplingPortWrite" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.apexSamplingPortWrite" id="21196" isSearchable="true" name="EVENT_SCN_apexSamplingPortWrite" syscallIdent="17,7">
                <EventParam formatStr="%lld" name="objPortHandle" type="UINT64"/>
                <EventParam formatStr="%lld" name="msgAddr" type="UINT64"/>
                <EventParam formatStr="%lld" name="msgLen" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="apexSamplingPortRead" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.apexSamplingPortRead" id="21197" isSearchable="true" name="EVENT_SCN_apexSamplingPortRead" syscallIdent="17,8">
                <EventParam formatStr="%lld" name="objPortHandle" type="UINT64"/>
                <EventParam formatStr="%lld" name="msgAddr" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pMsgLen" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pValidity" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="apexSamplingPortIdGet" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.apexSamplingPortIdGet" id="21198" isSearchable="true" name="EVENT_SCN_apexSamplingPortIdGet" syscallIdent="17,9">
                <EventParam formatStr="0x%llx" name="sPortName" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pObjPortHandle" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="apexSamplingPortStatusGet" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.apexSamplingPortStatusGet" id="21199" isSearchable="true" name="EVENT_SCN_apexSamplingPortStatusGet" syscallIdent="17,10">
                <EventParam formatStr="%lld" name="objPortHandle" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="portStatus" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="apexSamplingPortCurrStatusGet" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.apexSamplingPortCurrStatusGet" id="21200" isSearchable="true" name="EVENT_SCN_apexSamplingPortCurrStatusGet" syscallIdent="17,11">
                <EventParam formatStr="%lld" name="objPortHandle" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="portCurrStatus" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="apexSamplingReadUpdatedMsg" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.apexSamplingReadUpdatedMsg" id="21201" isSearchable="true" name="EVENT_SCN_apexSamplingReadUpdatedMsg" syscallIdent="17,12">
                <EventParam formatStr="%lld" name="objPortHandle" type="UINT64"/>
                <EventParam formatStr="%lld" name="msgAddr" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pMsgLen" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pUpdated" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="apexSamplingReadMsgCond" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.apexSamplingReadMsgCond" id="21202" isSearchable="true" name="EVENT_SCN_apexSamplingReadMsgCond" syscallIdent="17,13">
                <EventParam formatStr="%lld" name="objPortHandle" type="UINT64"/>
                <EventParam formatStr="%lld" name="refTimeStamp" type="UINT64"/>
                <EventParam formatStr="%lld" name="msgAddr" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pMsgLen" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="pTimestamp" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="hmOpen" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.hmOpen" id="21203" isSearchable="true" name="EVENT_SCN_hmOpen" syscallIdent="17,14">
                <EventParam formatStr="0x%llx" name="pTaskPrio" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="hmConnect" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.hmConnect" id="21204" isSearchable="true" name="EVENT_SCN_hmConnect" syscallIdent="17,15"/>
            <EventDescription displayName="hmEventSend" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.hmEventSend" id="21205" isSearchable="true" name="EVENT_SCN_hmEventSend" syscallIdent="17,16">
                <EventParam formatStr="%lld" name="hmCode" type="UINT64"/>
                <EventParam formatStr="%lld" name="subCode" type="UINT64"/>
                <EventParam formatStr="%lld" name="addInfo" type="UINT64"/>
                <EventParam formatStr="%lld" name="hmLevel" type="UINT64"/>
                <EventParam formatStr="%lld" name="taskId" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="addr" type="UINT64"/>
                <EventParam formatStr="%lld" name="msgLen" type="UINT64"/>
                <EventParam formatStr="0x%llx" name="msg" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="hmEventWait" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.hmEventWait" id="21206" isSearchable="true" name="EVENT_SCN_hmEventWait" syscallIdent="17,17">
                <EventParam formatStr="0x%llx" name="buffer" type="UINT64"/>
                <EventParam formatStr="%lld" name="maxNBytes" type="UINT64"/>
            </EventDescription>
            <EventDescription displayName="hmClose" hasTimeStamp="true" helpTopicId="VXWORKS6_EVENT_SCN_GENERIC" icon="color=#ff0000,text=sc.hmClose" id="21207" isSearchable="true" name="EVENT_SCN_hmClose" syscallIdent="17,18"/>
        </EventClass>
    </EventDictionary>
    )delim";
...
/*
modification history
01b,01feb10,tcr  changes for 64bit parameters
    ...
    <EventClass key="syscall" displayName="syscall Events" helpTopicId="VXWORKS6_SYSCALL_CLASS_HELP">
        ...
        <EventDescription id="10066" name="EVENT_SYSCALL_1" hasTimeStamp="true" isSearchable="true" helpTopicId="VXWORKS6_EVENT_SYSCALL_1_HELP"
          icon="color=#ff0000,text=syscall (1 param)">
            <EventParam type="UINT16" name="syscallId" formatStr="0x%08x"/>
            <EventParam type="UINT64" name="param1" formatStr="0x%016llx"/>
        </EventDescription>
        ...
        <EventDescription id="10067" name="EVENT_SYSCALL_2" hasTimeStamp="true" isSearchable="true" helpTopicId="VXWORKS6_EVENT_SYSCALL_2_HELP"
          icon="color=#ff0000,text=syscall (2 params)">
            <EventParam type="UINT16" name="syscallId" formatStr="0x%08x"/>
            <EventParam type="UINT64" name="param1" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="param2" formatStr="0x%016llx"/>
        </EventDescription>
        ...
        <EventDescription id="10068" name="EVENT_SYSCALL_3" hasTimeStamp="true" isSearchable="true" helpTopicId="VXWORKS6_EVENT_SYSCALL_3_HELP"
          icon="color=#ff0000,text=syscall (3 params)">
            ...
            <EventParam type="UINT64" name="param1" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="param2" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="param3" formatStr="0x%016llx"/>
        </EventDescription>
        ...
        <EventDescription id="10069" name="EVENT_SYSCALL_4" hasTimeStamp="true" isSearchable="true" helpTopicId="VXWORKS6_EVENT_SYSCALL_4_HELP"
          icon="color=#ff0000,text=syscall (4 params)">
            ...
            <EventParam type="UINT64" name="param2" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="param3" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="param4" formatStr="0x%016llx"/>
        </EventDescription>
        ...
        <EventDescription id="10070" name="EVENT_SYSCALL_5" hasTimeStamp="true" isSearchable="true" helpTopicId="VXWORKS6_EVENT_SYSCALL_5_HELP"
          icon="color=#ff0000,text=syscall (5 params)">
            ...
            <EventParam type="UINT64" name="param3" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="param4" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="param5" formatStr="0x%016llx"/>
        </EventDescription>
        ...
        <EventDescription id="10071" name="EVENT_SYSCALL_6" hasTimeStamp="true" isSearchable="true" helpTopicId="VXWORKS6_EVENT_SYSCALL_6_HELP"
          icon="color=#ff0000,text=syscall (6 params)">
            ...
            <EventParam type="UINT64" name="param4" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="param5" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="param6" formatStr="0x%016llx"/>
        </EventDescription>
        ...
        <EventDescription id="10072" name="EVENT_SYSCALL_7" hasTimeStamp="true" isSearchable="true" helpTopicId="VXWORKS6_EVENT_SYSCALL_7_HELP"
         ...
         <EventParam type="UINT16" name="syscallId" formatStr="0x%08x"/>
            ...
            <EventParam type="UINT64" name="param5" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="param6" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="param7" formatStr="0x%016llx"/>
        </EventDescription>
        ...
        <EventDescription id="10073" name="EVENT_SYSCALL_8" hasTimeStamp="true" isSearchable="true" helpTopicId="VXWORKS6_EVENT_SYSCALL_8_HELP"
          icon="color=#ff0000,text=syscall (8 params)">
            ...
            <EventParam type="UINT64" name="param6" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="param7" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="param8" formatStr="0x%016llx"/>
        </EventDescription>
        ...
        <EventDescription id="10074" name="EVENT_RETURN_OK" hasTimeStamp="true"
            ...
            <EventParam type="UINT64" name="result" formatStr="0x%016llx"/>
        </EventDescription>
        ...
        <EventDescription id="10075" name="EVENT_RETURN_ERR" hasTimeStamp="true"
            ...
            <EventParam type="UINT64" name="errno" formatStr="0x%016llx"/>
        </EventDescription>
        ...
        <EventDescription id="10076" name="EVENT_SYSCALL_BAD_ID"
            ...
            <EventParam type="UINT64" name="group" formatStr="0x%016llx"/>
            <EventParam type="UINT64" name="routine" formatStr="0x%016llx"/>
        </EventDescription>
    </EventClass>
...
<EventDictionary>
    <EventClass key="wind_tipc" displayName="Wind TIPC events">
	    ...
	    <EventParam type="UINT64" name="wvEvtInfo:" formatter="com.windriver.windview.plugins.wv.windtipc.formatters.TipcInfoDecoder"/>
	    <EventParam type="UINT64" name="Function Name" formatter="com.windriver.windview.plugins.wv.windtipc.formatters.FuncDecoder"/>
	    <EventParam type="UINT64" name="Qualifier" formatter="com.windriver.windview.plugins.wv.windtipc.formatters.QualifierDecoder"/>
	    ...
	    <EventParam type="UINT64" name="wvEvtInfo:" formatter="com.windriver.windview.plugins.wv.windtipc.formatters.TipcInfoDecoder"/>
	    <EventParam type="UINT64" name="Function Name" formatter="com.windriver.windview.plugins.wv.windtipc.formatters.FuncDecoder"/>
	    <EventParam type="UINT64" name="SubType" formatter="com.windriver.windview.plugins.wv.windtipc.formatters.InfoSubTypeDecoder"/>
            <EventParam type="BLOB" name="Passed parameters:" formatter="com.windriver.windview.plugins.wv.windtipc.formatters.TipcBlobDecoder"/>
        </EventDescription>
        <EventDescription id="20520" name="WV_TIPCEVENT_START" displayName ="wvTipcStart" icon="images/wvtipc-start.gif">
	    <EventParam type="UINT64" name="wvEvtInfo:" formatter="com.windriver.windview.plugins.wv.windtipc.formatters.TipcInfoDecoder"/>
	    <EventParam type="UINT64" name="Function Name"  formatter="com.windriver.windview.plugins.wv.windtipc.formatters.FuncDecoder"/>
	    <EventParam type="UINT64" name="Parameter P0" formatStr="0x%08x"/>
            <EventParam type="BLOB" name="Passed parameters:" formatter="com.windriver.windview.plugins.wv.windtipc.formatters.TipcBlobDecoder"/>
        </EventDescription>
...
/*
modification history
01a,01feb10,tcr  created from 6.7 version for vxWorks 6.9 64bit
*/
-->
...
<EventDictionary>
  <EventClass key="user" displayName="User Events" helpTopicId="VXWORKS6_user_CLASS_HELP">
    <EventRangeDescription eventIdStart="40000" eventIdCount="25536" nameRoot="EVENT_USER" displayNameRoot="user" nameRootSuffixStart="0" icon="text=$id,color=#FFAFFF,textPosition=southeast,icon=images/defaultUser.gif" trigger="true" helpTopicId="VXWORKS6_EVENT_USER_EVENT_HELP" handler="com.windriver.windview.plugins.wv.vxworks.UserEventDescription">
      <EventParam type="UINT64" name="pc" formatStr="0x%016llx"/>
      <EventParam type="BLOB" name="data" formatter="com.windriver.windview.agnostic.wv.SmartHexAsciiFormatter"/>
...
/* Copyright 2010, 2019 Wind River Systems, Inc. */
...
01e,20dec10,tcr  Fix errors in xml for 64bit logs
01d,16jun20,vhe  Improve lock level tracking for SV (WIND00209730)
01c,04feb10,tcr  update event argument types
01b,01feb10,tcr  update for 64bit params
01a,10jan10,tcr  created from 6.7/vxworks.xml
*/
-->
<!DOCTYPE EventDictionary SYSTEM "../../DTDs/EventDictionary.dtd">
<EventDictionary>
  <EventClass>
    <EventDescription id="0" name="EVENT_BEGIN" hasTimeStamp="false" isSearchable="false">
      ...
      <EventParam type="UINT64" name="taskIdCurrent" formatStr="0x%016llx"/>
	...
	<EventDescription id="1" name="EVENT_CALL_STACK" hasTimeStamp="false" isSearchable="false">
      	<EventParam type="UINT64" name="rtpId" formatStr="0x%016llx"/>
      	<EventParam type="UINT64" name="taskId" formatStr="0x%016llx"/>
    ...
    <EventDescription id="3" name="EVENT_TASKNAME" hasTimeStamp="false" isSearchable="false">
      <EventParam type="UINT64" name="status"/>
      <EventParam type="UINT64" name="priority"/>
      <EventParam type="UINT64" name="taskLockCount"/>
      <EventParam type="UINT64" name="taskId" formatStr="0x%016llx"/>
      <EventParam type="UINT64" name="entryPoint" formatStr="0x%016llx"/>
      <EventParam type="UINT64" name="rtpId" formatStr="0x%016llx"/>
      <EventParam type="UINT64" name="cpuIndex" formatStr="0x%016llx"/>
      <EventParam type="BLOB" name="name" formatStr="%s"/>
    </EventDescription>
    ...
    <EventDescription id="19" name="EVENT_IDLE_INFO"
      ...
      <EventParam type="UINT64" name="idleTaskId" formatStr="0x%016llx"/>
    </EventDescription>
    <EventDescription id="20" name="EVENT_MODULE_MAP"
                      hasTimeStamp="false" isSearchable="false">
      <EventParam type="UINT64" name="RtpId"/>
      <EventParam type="UINT64" name="textAddr"/>
      <EventParam type="UINT64" name="textSize"/>
      <EventParam type="UINT64" name="fileOffset"/>
  ...
  <EventClass key="krnl" displayName="Kernel Events" helpTopicId="VXWORKS6_krnl_CLASS_HELP">
    <EventDescription id="52" name="EVENT_WIND_EXIT_DISPATCH" displayName="[Exit - Task switch]" isSearchable="false">
      <EventParam type="UINT64" name="tid" formatStr="0x%016llx"/>
      <EventParam type="UINT64" name="priority"/>
    </EventDescription>
  ...
  <EventClass key="krnl" displayName="Kernel Events" helpTopicId="VXWORKS6_krnl_CLASS_HELP">
    <EventDescription id="600" name="EVENT_WINDSPAWN" displayName="[Spawn task]" hasTimeStamp="false" isSearchable="false">
      <EventParam isSearchKey="true" type="UINT64" name="pTcb" formatStr="0x%016llx"/>
      <EventParam type="UINT64" name="priority"/>
    </EventDescription>
    ...
    <EventDescription id="604" name="EVENT_WINDPRIORITYSETRAISE" displayName="[Task priority set - raise]" hasTimeStamp="false" isSearchable="false">
      <EventParam isSearchKey="true" type="UINT64" name="pTcb" formatStr="0x%016llx"/>
      <EventParam type="UINT64" name="oldPriority"/>
      <EventParam type="UINT64" name="priority"/>
    </EventDescription>
    ...
    <EventDescription id="606" name="EVENT_WINDSEMDELETE" displayName="[Delete semaphore]" hasTimeStamp="false" isSearchable="false">
      <EventParam isSearchKey="true" type="UINT64" name="semId" formatStr="0x%016llx"/>
    </EventDescription>
    ...
    <EventDescription id="611" name="EVENT_WINDWDSTART" displayName="[Start watchdog]" hasTimeStamp="false" isSearchable="false" helpTopicId="VXWORKS6_EVENT_WINDWDSTART_EVENT_HELP">
      <EventParam isSearchKey="true" type="UINT64" name="wdId" formatStr="0x%016llx"/>
    </EventDescription>
    ...
    <EventDescription id="623" name="EVENT_OBJ_MSGSEND" hasTimeStamp="false" isSearchable="false" helpTopicId="VXWORKS6_EVENT_OBJ_MSGSEND_EVENT_HELP">
      <EventParam isSearchKey="true" type="UINT64" name="msgQId" formatStr="0x%016llx"/>
    </EventDescription>
    ...
    <EventDescription id="627" name="EVENT_OBJ_SIGSUSPEND" hasTimeStamp="false" isSearchable="false" helpTopicId="VXWORKS6_EVENT_OBJ_SIGSUSPEND_EVENT_HELP">
      <EventParam type="UINT64" name="sigset" formatStr="0x%016llx"/>
    </EventDescription>
    ...
    <EventDescription id="646" name="EVENT_OBJ_WINDROTATE" hasTimeStamp="false" isSearchable="false">
      <EventParam type="UINT64" name="priority" formatStr="%lld"/>
    </EventDescription>
  ...
  <EventClass key="int" displayName="Interrupt Events" helpTopicId="VXWORKS6_int_CLASS_HELP">
    <EventDescription id="102" name="EVENT_INT_ENT_" trigger="true"
      ...
      <EventParam isSearchKey="true" type="UINT64" name="intNum" formatStr="0x%016llx"/>
    </EventDescription>
  ...
  <EventClass key="task" displayName="Task Events" helpTopicId="VXWORKS6_task_CLASS_HELP">
    ...
    <EventDescription id="10000" name="EVENT_TASKSPAWN" trigger="true" displayName="taskSpawn" icon="images/taskSpawn.gif" helpTopicId="VXWORKS6_EVENT_TASKSPAWN_EVENT_HELP">
      ...
      <EventParam type="UINT64" name="priority"/>
      <EventParam type="UINT64" name="stackSize"/>
      <EventParam type="UINT64" name="entryPt" formatStr="0x%016llx"/>
      <EventParam type="UINT64" name="options" formatter="com.windriver.windview.plugins.wv.vxworks6.parmfmt.TaskSpawnOptions"/>
    </EventDescription>
    <EventDescription id="10001" name="EVENT_TASKDESTROY" trigger="true" displayName="taskDelete" icon="images/taskDelete.gif" helpTopicId="VXWORKS6_EVENT_TASKDESTROY_EVENT_HELP">
      <EventParam isSearchKey="true" type="UINT64" name="pTcb" formatStr="0x%016llx"/>
      <EventParam type="UINT64" name="safeCnt"/>
    </EventDescription>
    ...
    <EventDescription id="10003" name="EVENT_TASKPRIORITYSET" trigger="true" displayName="taskPrioritySet" icon="images/taskPrioritySet.gif" helpTopicId="VXWORKS6_EVENT_TASKPRIORITYSET_EVENT_HELP">
      ...
      <EventParam isSearchKey="true" type="UINT64" name="pTcb" formatStr="0x%016llx"/>
      <EventParam type="UINT64" name="newPri"/>
      <EventParam type="UINT64" name="oldPri"/>
    </EventDescription>
    ...
    <EventDescription id="10044" name="EVENT_TASKCONT" trigger="true" displayName="taskCont" icon="images/taskCont.gif" helpTopicId="VXWORKS6_EVENT_TASKCONT_EVENT_HELP">
      ...
      <EventParam isSearchKey="true" type="UINT64" name="taskId" formatStr="0x%016llx"/>
      <EventParam isSearchKey="false" type="UINT64" name="priority" formatStr="0x%016llx"/>
    </EventDescription>
    ...
    <EventDescription id="10230" name="EVENT_TASK_CPU_AFFINITY_SET" trigger="true" displayName="taskCpuAffinitySet" icon="images/taskCpuAffinitySet.png" helpTopicId="VXWORKS6_EVENT_TASKCPU_AFFINITY_SET_EVENT_HELP">
      <EventParam type="UINT64" name="affinity" formatStr="0x%016llx"/>
      <EventParam type="UINT64" isSearchKey="true" name="taskId" formatStr="0x%016llx"/>
    </EventDescription>
  ...
  <EventClass key="errnoset" displayName="Errno Set Events" helpTopicId="VXWORKS6_errnoset_CLASS_HELP">
    <EventDescription id="10254" name="EVENT_SET_ERRNO" trigger="true" displayName="errnoSet" >
      <EventParam type="UINT64" name="errno" formatStr="0x%llx"/>
    </EventDescription>
    <EventDescription id="10255" name="EVENT_SET_TASK_ERRNO" trigger="true" displayName="taskErrnoSet" >
      <EventParam type="UINT64" name="tid" formatStr="0x%llx"/>
      <EventParam type="UINT64" name="errno" formatStr="0x%llx"/>
    </EventDescription>
  </EventClass>
  <EventClass key="sem" displayName="Semaphore Events" helpTopicId="VXWORKS6_sem_CLASS_HELP">
    <EventDescription id="10008" name="EVENT_SEMBCREATE" trigger="true" displayName="semBCreate" icon="images/semBCreate.gif" helpTopicId="VXWORKS6_EVENT_SEMBCREATE_EVENT_HELP">
      <EventParam isSearchKey="true" type="UINT64" name="semId" formatStr="0x%016llx"/>
      <EventParam type="UINT64" name="options" formatter="com.windriver.windview.plugins.wv.vxworks6.parmfmt.SemCreateOptions"/>
      <EventParam type="UINT64" name="semOwner" formatStr="0x%016llx"/>
    </EventDescription>
    <EventDescription id="10009" name="EVENT_SEMCCREATE" trigger="true" displayName="semCCreate" icon="images/semCCreate.gif" helpTopicId="VXWORKS6_EVENT_SEMCCREATE_EVENT_HELP">
      <EventParam isSearchKey="true" type="UINT64" name="semId" formatStr="0x%016llx"/>
      <EventParam type="UINT64" name="options" formatter="com.windriver.windview.plugins.wv.vxworks6.parmfmt.SemCreateOptions"/>
      <EventParam type="UINT64" name="initialCount"/>
    </EventDescription>
    <EventDescription id="10010" name="EVENT_SEMDELETE" trigger="true" displayName="semDelete" icon="images/semDelete.gif" helpTopicId="VXWORKS6_EVENT_SEMDELETE_EVENT_HELP">
      <EventParam isSearchKey="true" type="UINT64" name="semId" formatStr="0x%016llx"/>
      <EventParam type="UINT64" name="owner"/>
      <EventParam type="UINT64" name="recurse"/>
      <EventParam type="UINT64" name="qHead" formatStr="0x%016llx"/>
    </EventDescription>
    ...
    <EventDescription id="10013" name="EVENT_SEMMCREATE" trigger="true" displayName="semMCreate" icon="images/semMCreate.gif" helpTopicId="VXWORKS6_EVENT_SEMMCREATE_EVENT_HELP">
      <EventParam isSearchKey="true" type="UINT64" name="semId" formatStr="0x%016llx"/>
      <EventParam type="UINT64" name="options" formatter="com.windriver.windview.plugins.wv.vxworks6.parmfmt.SemMCreateOptions"/>
      <EventParam type="UINT64" name="semOwner" formatStr="0x%016llx"/>
    </EventDescription>
    ...
    <EventDescription id="10204" name="EVENT_SEMRWCREATE" trigger="true" displayName="semRWCreate" icon="images/semRWCreate.gif" helpTopicId="VXWORKS6_EVENT_SEMRWCREATE_EVENT_HELP">
      <EventParam isSearchKey="true" type="UINT64" name="semId" formatStr="0x%016llx"/>
      <EventParam type="UINT64" name="maxReaders" formatStr="%lld"/>
      <EventParam type="UINT64" name="options" formatter="com.windriver.windview.plugins.wv.vxworks6.parmfmt.SemMCreateOptions"/>
      <EventParam type="UINT64" name="semOwner" formatStr="0x%016llx"/>
    </EventDescription>
    ...
    <EventDescription id="10205" name="EVENT_SEMRTAKE" trigger="true" displayName="semRTake" icon="images/semRTake.gif" helpTopicId="VXWORKS6_EVENT_SEMRTAKE_EVENT_HELP">
      <EventParam isSearchKey="true" type="UINT64" name="semId" formatStr="0x%016llx"/>
      <EventParam type="UINT64" name="owner" formatStr="0x%016llx"/>
      <EventParam type="UINT64" name="recurse" formatStr="%lld"/>
    </EventDescription>
  ...
  <EventClass key="wd" displayName="Watchdog Events" helpTopicId="VXWORKS6_wd_CLASS_HELP">
    ...
    <EventDescription id="10018" name="EVENT_WDSTART" trigger="true" displayName="wdStart" icon="images/wdStart.gif" helpTopicId="VXWORKS6_EVENT_WDSTART_EVENT_HELP">
      ...
      <EventParam isSearchKey="true" type="UINT64" name="wdId" formatStr="0x%016llx"/>
      <EventParam type="UINT64" name="delay"/>
    </EventDescription>
  ...
  <EventClass key="msgQ" displayName="Message Queue Events" helpTopicId="VXWORKS6_msgq_CLASS_HELP">
    <EventDescription id="10020" name="EVENT_MSGQCREATE" trigger="true" displayName="msgQCreate" icon="images/msgQCreate.gif" helpTopicId="VXWORKS6_EVENT_MSGQCREATE_EVENT_HELP">
      ...
      <EventParam isSearchKey="true" type="UINT64" name="msgQId" formatStr="0x%016llx"/>
      <EventParam type="UINT64" name="maxMsg"/>
      <EventParam type="UINT64" name="maxMsgLen"/>
      <EventParam type="UINT64" name="options" formatter="com.windriver.windview.plugins.wv.vxworks6.parmfmt.MsgQCreateOptions"/>
    ...
    <EventDescription id="10022" name="EVENT_MSGQRECEIVE" trigger="true" displayName="msgQReceive" icon="images/msgQReceive.gif" helpTopicId="VXWORKS6_EVENT_MSGQRECEIVE_EVENT_HELP">
      <EventParam isSearchKey="true" type="UINT64" name="msgQId" formatStr="0x%016llx"/>
      <EventParam type="UINT64" name="buffer" formatStr="0x%016llx"/>
      <EventParam type="UINT64" name="bufSize"/>
      <EventParam type="UINT64" name="timeout" formatter="com.windriver.windview.plugins.wv.vxworks6.parmfmt.WaitOptions"/>
    </EventDescription>
    <EventDescription id="10023" name="EVENT_MSGQSEND" trigger="true" displayName="msgQSend" icon="images/msgQSend.gif" helpTopicId="VXWORKS6_EVENT_MSGQSEND_EVENT_HELP">
      ...
      <EventParam type="UINT64" name="bufSize"/>
      <EventParam type="UINT64" name="timeout" formatter="com.windriver.windview.plugins.wv.vxworks6.parmfmt.WaitOptions"/>
      <EventParam type="UINT64" name="priority" formatter="com.windriver.windview.plugins.wv.vxworks6.parmfmt.MsgQPriorityOptions"/>
    </EventDescription>
  </EventClass>
  <EventClass key="sig" displayName="Signals" helpTopicId="VXWORKS6_sig_CLASS_HELP">
    <EventDescription id="60" name="EVENT_EXCEPTION" trigger="true" displayName="exception" icon="images/exception.gif" helpTopicId="VXWORKS6_EVENT_EXCEPTION_EVENT_HELP">
      ...
      <EventParam type="UINT64" name="exception" formatStr="0x%016llx"/>
    </EventDescription>
    <EventDescription id="10024" name="EVENT_SIGNAL" trigger="true" displayName="signal" icon="images/signal.gif" helpTopicId="VXWORKS6_EVENT_SIGNAL_EVENT_HELP">
      ...
      <EventParam isSearchKey="true" type="UINT64" name="signo" formatStr="0x%llx"/>
      <EventParam type="UINT64" name="handler" formatter="com.windriver.windview.plugins.wv.vxworks6.parmfmt.SignalHandlerOptions"/>
    </EventDescription>
    ...
    <EventDescription id="10027" name="EVENT_KILL" trigger="true" displayName="kill" icon="images/kill.gif" helpTopicId="VXWORKS6_EVENT_KILL_EVENT_HELP">
      ...
      <EventParam type="UINT64" name="signo" formatStr="0x%llx"/>
      <EventParam type="UINT64" name="tid" formatStr="0x%016llx"/>
    </EventDescription>
    ...
    <EventDescription id="10077" name="EVENT_OBJ_VERIFY_FAIL" trigger="true" displayName="OBJ_VERIFY fail" icon="images/obj_verify_fail.gif" helpTopicId="VXWORKS6_EVENT_OBJ_VERIFY_FAILEVENT_HELP">
      ...
      <EventParam type="UINT64" isSearchKey="true" name="objId" formatStr="0x%016llx"/>
      <EventParam type="UINT64" name="classId" formatStr="0x%016llx"/>
    </EventDescription>
  </EventClass>
  ...
  <EventClass key="events" displayName="Event Events" helpTopicId="VXWORKS6_events_CLASS_HELP">
    <EventDescription id="10057" name="EVENT_EVENTSEND" trigger="true" displayName="eventSend" icon="images/eventSend.gif" helpTopicId="VXWORKS6_EVENT_EVENTSEND_EVENT_HELP">
      ...
      <EventParam isSearchKey="true" type="UINT64" name="taskId" formatStr="0x%016llx"/>
      <EventParam type="UINT64" name="events" formatStr="0x%016llx"/>
    </EventDescription>
    <EventDescription id="10058" name="EVENT_EVENTRECEIVE" trigger="true" displayName="eventReceive" icon="images/eventReceive.gif" helpTopicId="VXWORKS6_EVENT_EVENTRECEIVE_EVENT_HELP">
      <EventParam type="UINT64" name="events" formatStr="0x%016llx"/>
      <EventParam type="UINT64" name="timeout" formatter="com.windriver.windview.plugins.wv.vxworks6.parmfmt.WaitOptions"/>
      <EventParam type="UINT64" name="flags" formatter="com.windriver.windview.plugins.wv.vxworks6.parmfmt.EventReceiveOptions"/>
    </EventDescription>
  ...
  <EventClass key="state" displayName="State Change Events" helpTopicId="VXWORKS6_state_CLASS_HELP">
    <EventDescription id="61" name="EVENT_TASK_STATECHANGE" displayName="State change" isSearchable="false">
      <EventParam isSearchKey="true" type="UINT64" name="taskId" formatStr="0x%016llx"/>
      <EventParam type="UINT64" name="oldState" formatter="com.windriver.windview.agnostic.wv.StateTypeDecoder"/>
      <EventParam type="UINT64" name="newState" formatter="com.windriver.windview.agnostic.wv.StateTypeDecoder"/>
    </EventDescription>
  </EventClass>
